...
// schema - validation
let saveAsDraftTrnRtiAppealSchema = yup.object().shape({
    // applicationNo: yup
    // .string()
    ...
    appealReason:yup.string().max(5000, <FormattedLabel id='reasonMaxLen' />),
...
export default saveAsDraftTrnRtiAppealSchema;