...
// parawiseRequestLcClerk in Marathi
export let parawiseRequestLcClerkMr = yup.object().shape({
  // clerkRemarkEnglish: yup
  //   .string()
  //   .matches(
  //     //  /^[A-Za-z.]*$/,
...
// parawiseRequestLcConcernClerk in Marati

export let parawiseRequestLcConcernClerk1 = yup.object().shape({
  parawiseRequestDao: yup
    .array()
    .of(yup.object().shape(parawiseRequestLcConcernClerk)),
});

// concern Department HOD
export let parawiseRequestLcConcernHOD = yup.object().shape({
  // hodRemarkEnglish
  concHodRemarkEnglish: yup
    .string()
    .matches(
      //  /^[A-Za-z.]*$/,
      // /^[a-zA-Z0-9 .]*$/,
...
export let advocate1 = yup.object().shape({
  parawiseRequestDao: yup.array().of(yup.object().shape(advocate)),
});

// Writtern Statement Approval by Legal HOD
export let wsApprovalByLegalHOD = yup.object().shape({
  // hodRemarkEnglish
  finalAssignedRemarkByLegalHod: yup
    .string()
    .matches(
      //  /^[A-Za-z.]*$/,
      // /^[a-zA-Z0-9 .]*$/,
  ...
  finalAssignedRemarkByLegalHodMr: yup
    .string()
    .matches(
      // /^[aA-zZ\s]+$/,
      // /^[a-zA-Z0-9.]*$/,
