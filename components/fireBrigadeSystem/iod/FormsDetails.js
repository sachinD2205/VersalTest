...
const FormsDetails = ({ view = false, readOnly = false }) => {
  ...
  const directionDetailsTableColumn = [
    ...
    },
    {
      ...
      headerName: <FormattedLabel id="approachRoad" />,
      flex: 1,
      renderCell: (params) => {
        return (
          <>
  ...
  }, [watch("approachRoadDirection"), watch("roadWidth")]);

  // const handleCapacity = (type, value) => {
  //   console.log(
  //     "22675656",
  //     watch("tankLocation"),
  //     watch("capacity"),
  //     watch("formDTLIodDao.totalUndergroundCap")
  //   );
  //   if (watch("tankLocation") == 2) {
  //     let total = 0;
  //     let test1 = watch("formDTLIodDao.totalUndergroundCap");
  //     let test2 = watch("capacity");
  //     if (
  //       watch("formDTLIodDao.totalUndergroundCap") != null ||
  //       watch("formDTLIodDao.totalUndergroundCap") != undefined ||
  //       watch("formDTLIodDao.totalUndergroundCap") != ""
  //     ) {
  //       total = test1 + test2;
  //     } else {
  //       console.log("test32323232", test2);
  //       total = test2;
  //     }
  //     console.log("total23234324", total);
  //     // setValue("formDTLIodDao.totalUndergroundCap", total);
  //   } else if (watch("tankLocation") == 1) {
  //     setValue(
  //       "formDTLIodDao.totalOverheadCap",
  //       watch("formDTLIodDao.totalOverheadCap") >= 0
  //         ? watch("formDTLIodDao.totalOverheadCap") + value
  //         : value
  //     );
  //   }
  ...
  //   // if (type == 2) {
  //   //   setValue(
  //   //     "formDTLIodDao.totalUndergroundCap",
  //   //     watch("formDTLIodDao.totalUndergroundCap") >= 0
  //   //       ? watch("formDTLIodDao.totalUndergroundCap") + value
  //   //       : value
  //   //   );
  //   // }
  //   // if (type == 1) {
  ...
  useEffect(() => {
    const isUnderGroundWaterTank = watch(
      "formDTLIodDao.isPlanhaveUnderGroundWaterTank"
    );

    if (isUnderGroundWaterTank === "N") {
      console.log("876", watch("formDTLIodDao.isPlanhaveUnderGroundWaterTank"));
      setTankLocation(" ");
      setTankType(" ");
      setLength(" ");
      setBreadth(" ");
  ...
  }, [watch("formDTLIodDao.isPlanhaveUnderGroundWaterTank")]);
  ...
  const savePropertyDetails = () => {
    ...
    // getAlredyData
    let tempPropertyDTLDao = watch("formDTLIodDao.propertyDTLDao");
    ...
    if (
      ...
      if (
        ...
        setValue("formDTLIodDao.propertyDTLDao", [
          ...tempPropertyDTLDao,
      ...
      setValue("formDTLIodDao.propertyDTLDao", [currentPropertyDetails]);
    }
  ...
  const saveTankDetails = () => {
    ...
    // getAlredyData
    let tempWaterTankDTLDao = watch("formDTLIodDao.underGroundWaterTankDao");
    ...
    if (
      ...
      if (
        ...
        // ifAlredyRecordNotExit - Save
        setValue("formDTLIodDao.underGroundWaterTankDao", [
          ...tempWaterTankDTLDao,
  ...
  const saveDirectionDetails = () => {
    ...
    // getAlredyData
    let tempDirectionDTLDao = watch("formDTLIodDao.approachRoadDTLDao");
    ...
    if (
      ...
      if (
        ...
        // ifAlredyRecordNotExit - Save
        setValue("formDTLIodDao.approachRoadDTLDao", [
          ...tempDirectionDTLDao,
          currentDirectionDao,
        ]);
      } else {
      ...
      // ifArrayIsEmpty - firstRecordInTable
      setValue("formDTLIodDao.approachRoadDTLDao", [currentDirectionDao]);
    }
  ...
  const deleteByIdPtax = async (value) => {
    ...
    swal({
      ...
      if (willDelete) {
        let tempPropertyDTLDaoPtax = watch("formDTLIodDao.propertyDTLDao");
    ...
    swal({
      ...
      if (willDelete) {
        let tempPropertyDTLDaoWaterTank = watch(
          "formDTLIodDao.underGroundWaterTankDao"
        );
    ...
    swal({
      ...
      if (willDelete) {
        let tempPropertyDTLDaoDirection = watch(
          "formDTLIodDao.approachRoadDTLDao"
        );
  ...
  useEffect(() => {
    ...
    console.log("propertyDTLDao2329", watch("formDTLIodDao.propertyDTLDao"));

    // filterTableData-ActiveFlag "Y"
    const tempTableDataWithFlagYPtax = watch(
      "formDTLIodDao.propertyDTLDao"
    )?.filter((data, index) => {
  ...
  // Direction
  useEffect(() => {
    console.log("directionDao121", watch("formDTLIodDao.approachRoadDTLDao"));
      ...
      >
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.formName")}
            // error={!!errors?.formDTLIodDao?.formName}
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            label="Final plot no"
            variant="standard"
            {...register("formDTLIodDao.finalPlotNo")}
            // error={!!errors?.formDTLIodDao?.finalPlotNo}
            // helperText={
            //   errors?.formDTLIodDao?.finalPlotNo
            //     ? errors?.formDTLIodDao?.finalPlotNo.message
            //     : null
            // }
          />
        </Grid>
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.plotAreaSquareMeter")}
            // error={!!errors?.formDTLIodDao?.plotAreaSquareMeter}
            // helperText={
            //   errors?.formDTLIodDao?.plotAreaSquareMeter
            //     ? errors?.formDTLIodDao?.plotAreaSquareMeter.message
            //     : null
            // }
          />
        </Grid>
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.constructionAreSqMeter")}
            // error={!!errors?.formDTLIodDao?.constructionAreSqMeter}
            // helperText={
            //   errors?.formDTLIodDao?.constructionAreSqMeter
            //     ? errors?.formDTLIodDao?.constructionAreSqMeter.message
            //     : null
            // }
          />
        </Grid>
        ...
        {/* <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.noOfApprochedRoad")}
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.highTensionLine")}
            // error={!!errors?.formDTLIodDao?.highTensionLine}
            // helperText={
            //   errors?.formDTLIodDao?.highTensionLine
            //     ? errors?.formDTLIodDao?.highTensionLine.message
            //     : null
            // }
          />
        </Grid>
        ...
        {/* <Grid item xs={4} className={styles.feildres}>
          <FormControl sx={{ width: "80%" }}>
            ...
            <Controller
              ...
              name="formDTLIodDao.previouslyAnyFireNocTaken"
              control={control}
              defaultValue=""
            />
          </FormControl>
...
*/}
        {/* <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.underTheGroundWaterTankCapacityLitre")}
        ...
        {/* <Grid item xs={4} className={styles.feildres}>
          ...
          >
            ...
            <Controller
              ...
              name="formDTLIodDao.accessRoadWidth"
              control={control}
              defaultValue=""
            />
            <FormHelperText>
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.revenueSurveyNo")}
            // error={!!errors?.formDTLIodDao?.revenueSurveyNo}
            // helperText={
            //   errors?.formDTLIodDao?.revenueSurveyNo
            //     ? errors?.formDTLIodDao?.revenueSurveyNo.message
            //     : null
            // }
          />
        </Grid>
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            variant="standard"
            {...register("formDTLIodDao.blockNo")}
            // error={!!errors?.formDTLIodDao?.blockNo}
            // helperText={
            //   errors?.formDTLIodDao?.blockNo
            //     ? errors?.formDTLIodDao?.blockNo.message
            //     : null
            // }
          />
        </Grid>
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            label="dp op no"
            variant="standard"
            {...register("formDTLIodDao.dpOpNo")}
            // error={!!errors?.formDTLIodDao?.dpOpNo}
            // helperText={
            //   errors?.formDTLIodDao?.dpOpNo
            //     ? errors?.formDTLIodDao?.dpOpNo.message
            //     : null
            // }
          />
        </Grid>
        ...
        <Grid item xs={4} className={styles.feildres}>
          <TextField
            ...
            label="Site Address"
            variant="standard"
            {...register("formDTLIodDao.siteAddress")}
            // error={!!errors?.formDTLIodDao?.siteAddress}
            // helperText={
            //   errors?.formDTLIodDao?.siteAddress
            //     ? errors?.formDTLIodDao?.siteAddress.message
            //     : null
            // }
          />
        </Grid>
                  ...
                  >
                    ...
                    >
                      ...
                      <Grid item xs={4} className={styles.feildres}>
                        ...
                        >
                          <InputLabel id="demo-simple-select-standard-label">
                            <FormattedLabel id="approachRoad" />
                          </InputLabel>
                          <Controller
                            render={({ field }) => (
                              <Select
      ...
      <Grid item xs={4} sx={{ margin: "3%" }}>
        <FormControl component="fieldset" sx={{ marginTop: "1%" }}>
          ...
          <Controller
            name="formDTLIodDao.isPlanhaveUnderGroundWaterTank"
            control={control}
            render={({ field }) => (
              <RadioGroup
          ...
          />
          {/* <FormHelperText
            error={!!errors?.formDTLIodDao?.isPlanhaveUnderGroundWaterTank}
          >
            {errors?.formDTLIodDao?.isPlanhaveUnderGroundWaterTank
              ? errors?.formDTLIodDao?.isPlanhaveUnderGroundWaterTank?.message
              : null}
          </FormHelperText> */}
        </FormControl>
        {console.log(
            ...
            <Grid container className={styles.feildres} spacing={2}>
              ...
              <Grid item xs={4} className={styles.feildres}>
                <TextField
                  ...
                  variant="standard"
                  {...register("formDTLIodDao.totalOverheadCap")}
                  // error={!!errors?.formDTLIodDao?.totalOverheadCap}
                  // helperText={
                  //   errors?.formDTLIodDao?.totalOverheadCap
                  //     ? errors?.formDTLIodDao?.totalOverheadCap.message
                  //     : null
                  // }
                />
              </Grid>
              ...
              <Grid item xs={4} className={styles.feildres}>
                <TextField
                  ...
                  variant="standard"
                  {...register("formDTLIodDao.totalUndergroundCap")}
                  // error={!!errors?.formDTLIodDao?.totalUndergroundCap}
                  // helperText={
                  //   errors?.formDTLIodDao?.totalUndergroundCap
                  //     ? errors?.formDTLIodDao?.totalUndergroundCap.message
                  //     : null
                  // }
                />
              </Grid>
