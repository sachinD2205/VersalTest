...
export let personalDetailsSchema = yup.object().shape({
  ...
  panNo: yup
    ...
    .required(<FormattedLabel id="panNoVal" />),
  buildingNo: yup.string().required(<FormattedLabel id="flatNoVal" />),
  emailAddress: yup
    .string()
    .email()
    .required(<FormattedLabel id="emailVal" />),
  //   address: yup.string().required(<FormattedLabel id="addressVal"/>),
  villageName: yup
    .string()
    .nullable()
    .required(<FormattedLabel id="villegeVal" />),
  serveyNo: yup
    .string()
    .nullable()
    .required(<FormattedLabel id="serveyNoVal" />),
  citySurveyNo: yup
    .string()
    .nullable()
    .required(<FormattedLabel id="cityServeyNoVal" />),
  buildingName: yup
    .string()
    .nullable()
    .required(<FormattedLabel id="buildingNameVal" />),
  area: yup
    .string()
    .nullable()
    .required(<FormattedLabel id="areaVal" />),
