      ...
      >
        ...
        >
          ...
          <Autocomplete
            ...
            options={areaDetails}
            getOptionLabel={(j) => language === "en" ? j.areaName : j.areaNameMr}
            noOptionsText= {language === "en" ? "Please Enter Area" : "कृपया क्षेत्र प्रविष्ट करा"}
            renderInput={(params) => (
              <TextField
                {...params}
                sx={{
        ...
        <Divider
          sx={{ borderBottomWidth: 1, width: "100%", marginTop: "3rem" }}
        />
      </Grid>
    </>
  );
