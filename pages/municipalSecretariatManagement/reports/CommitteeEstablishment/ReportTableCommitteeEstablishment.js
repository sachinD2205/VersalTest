      ...
      {props.rows.map((rowData, index) => {
        return (
          <tr key={index} style={{ ...styles.tableRow, textAlign: "center" }}>
            ...
            <td style={styles.tableRowData}>{rowData.fromDate}</td>
            <td style={styles.tableRowData}>{rowData.toDate}</td>
            <td style={styles.tableRowData}>
              {language === "en"
                ? rowData.committeeNameEn
                : rowData.committeeNameMr}
            </td>
            <td style={styles.tableRowData}>
              {rowData.committeeDismissedDate}
            </td>
            <td style={styles.tableRowData}>
              {rowData.committeeDismissedDate}
            </td>
            <td style={styles.tableRowData}>{rowData.status}</td>
          </tr>
        )
      })}
    </table>
