...
const Documents = (props) => {
  ...
  const [trnOpinionAttachmentDao, settrnOpinionAttachmentDao] = useState([]);
  ...
  useEffect(() => {
    // alert("!== aaya");
    if (localStorage.getItem("trnOpinionAttachmentDao")) {
      // alert("!== null");
      console.log(
        ":!== null",
        JSON.parse(localStorage.getItem("trnOpinionAttachmentDao"))
      );
      settrnOpinionAttachmentDao(
        JSON.parse(localStorage.getItem("trnOpinionAttachmentDao"))
      );
      setMainFiles(JSON.parse(localStorage.getItem("trnOpinionAttachmentDao")));
      // setAdditionalFiles(
      //   JSON.parse(localStorage.getItem("trnOpinionAttachmentDao"))
      // );
    }
  ...
  useEffect(() => {}, [trnOpinionAttachmentDao, mainFiles, additionalFiles]);
