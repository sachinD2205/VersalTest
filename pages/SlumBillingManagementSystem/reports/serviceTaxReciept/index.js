...
const Index = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: language == "en" ? "Service Tax Reciept" : "सेवा कर पावती",
  });
  ...
  const onSubmitFunc = () => {
    if (watch("hutNo")) {
      ...
      axios
        .post(
          `${urls.SLUMURL}/report/getServiceTaxReceiptReport`,
          apiBodyToSend,
          {
            headers: {
              Authorization: `Bearer ${user.token}`,
            ...
            if (res?.data.length > 0) {
              setData(
                res?.data?.map((r, i) => ({
                  ...
                  date: moment(r?.billDate).format("DD-MM-YYYY"),
                  action: r?.action,
                }))
              );
              setEngReportsData(
              ...
              setMrReportsData(
                res?.data?.map((r, i) => ({
                  ...
                  तारीख: moment(r?.billDate).format("DD-MM-YYYY"),
                  कृती: r?.action,
                }))
              );
              setLoading(false);
  ...
  function generateCSVFile(data) {
    ...
    const fileName = language == "en" ? "Service Tax Reciept" : "सेवा कर पावती";
    let col = () => {};
    col();
    const fileType =
    ...
    ws.F4 = {
      ...
      v:
        language == "en"
          ? `Report Name: Service Tax Reciept`
          : `अहवालाचे नाव: सेवा कर पावती`,
      s: dataStyle,
    };
    ws.F5 = {
      t: "s",
        ...
        <Box>
          <Grid container className={commonStyles.title}>
            ...
            <Grid item xs={11}>
              ...
              >
                <FormattedLabel id="serviceTaxReciept" />
              </h3>
            </Grid>
          </Grid>
        </Box>
