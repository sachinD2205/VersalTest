...
const Index = () => {
  const methods = useForm({
    resolver: yupResolver(flagMasterSchema),
    mode: "onChange",
  });
  const {
    register,
  ...
  const columns = [
    ...
    {
      field: language == "en" ? "flagName" : "flagNameMr",
    ...
    <>
      ...
      >
                ...
                <Grid container spacing={2} sx={{ padding: "1rem" }}>
                          ...
                          >
                            {applicableOnTypes &&
                              applicableOnTypes.map((value, index) => (
                                <MenuItem key={index} s value={value?.id}>
                                  {value?.key}
                                </MenuItem>
                              ))}
                          </Select>
                  ...
                  /> */}
                    ...
                    <Transliteration
                      ...
                      labelName={"flagName"}
                      fieldName={"flagName"}
                      updateFieldName={"flagNameMr"}
                      sourceLang={"eng"}
                      width={"90%"}
                      targetLang={"mar"}
                      label={<FormattedLabel id="flagName" required />}
                      error={!!errors.flagName}
                      helperText={
                        errors?.flagName ? errors.flagName.message : null
                      }
                  ...
                  /> */}
                    ...
                    <Transliteration
                      variant={"standard"}
                      _key={"flagNameMr"}
                      labelName={"flagNameMr"}
                      fieldName={"flagNameMr"}
                      updateFieldName={"flagName"}
                      sourceLang={"eng"}
                      width={"90%"}
                      targetLang={"mar"}
                      label={<FormattedLabel id="flagNameMr" required />}
                      error={!!errors.flagNameMr}
                      helperText={
                        errors?.flagNameMr ? errors.flagNameMr.message : null
                      }
        ...
        <DataGrid
          ...
          onPageChange={(_data) => {
            setDataPage(_data);
            getFlagDetails(data.pageSize, _data);
          }}
          onPageSizeChange={(_data) => {
            setDataPage(_data);
            getFlagDetails(_data, data.page);
          }}
        />
      </Paper>
    </>
