...
import schema from "../../../../containers/reuseableComponents/FormattedLabel";
...
const Index = (props) => {
  ...
  useEffect(() => {
    if (props.data.hutKey != null) {
      getHutData(props.data?.hutKey);
    }
  }, [props.data]);
  ...
  useEffect(() => {
    if (props.data != null) {
      ...
      if(res?.trnVisitScheduleList!=null&&res?.trnVisitScheduleList.length!=0){
        setValue(
          "scheduledTime",
        ...
        for (let i = 1; i <= 5; i++) {
          ...
          if (attachedDocument != null) {
            doc.push({
              id: i,
              filenm: DecryptData("passphraseaaaaaaaaupload", attachedDocument)
                .split("/")
                .pop()
                .split("_")
                .pop(),
      ...
      getIcardPhoto(res?.proposedOwnerPhoto);
      setDocList(
  ...
  }, [props, hutData, language, statusAll]);
      ...
      const tempData = axios
        ...
        .then((res) => {
          if (res.status == 201) {
            sweetAlert(
              "Issued!",
              `Hut ${dataSource.applicationNo} Transfer  successfully !`,
              "success"
            );
            router.push(
              "/SlumBillingManagementSystem/transactions/hutTransfer/hutTransferDetails"
          ...
          <>
            {statusVal != 2 && (
              <>
                ...
                {/* complete site visit */}
                {statusVal != 2 && statusVal != 15 && statusVal != 28 && (
                  <>
                    {" "}
                    <Box>
                      <Grid container className={commonStyles.title}>
                    ...
                    <Grid container spacing={2} sx={{ padding: "1rem" }}>
                          ...
                          render={({ field }) => (
                            <LocalizationProvider dateAdapter={AdapterMoment}>
                              <DateTimePicker
                                ...
                                label={
                                  <FormattedLabel id="visitDateTime" required />
                                }
                                onChange={(date) => {
                                  const formattedDate =
                                    moment(date).format("YYYY-MM-DD");
                      ...
                      <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
                        <TextField
                          ...
                          helperText={
                            error?.slattitude ? error.slattitude.message : null
                          }
                        />
                      </Grid>
                      <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
                        <TextField
                          ...
                          helperText={
                            error?.slongitude ? error.slongitude.message : null
                          }
                        />
                      </Grid>
                      <Grid item xl={4} lg={4} md={6} sm={6} xs={12}>
                    ...
                    <Grid container spacing={2} sx={{ padding: "1rem" }}>
                      <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                        <TextField
                          ...
                          multiline
                          onChange={(e) =>
                            handleRemarkChange(e, "completeApprovalRemark")
                          }
                          error={!!error.remarks}
                          helperText={
                  ...
                  statusVal != 14 && (
                    <>
                      ...
                      <Grid container spacing={2} sx={{ padding: "1rem" }}>
                        ...
                        {(watch("finalApprovedRemark") || statusVal === 17) && (
                          <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                            <TextField
                              sx={{ m: { xs: 0, md: 1 }, minWidth: "100%" }}
                              label={
