...
const Index = ({
  ...
  const handleGeneratePdf = () => {
    handleClose();
    setSelfAttestationFlag(checked);
    let opt = {
      margin: 1,
...
class ComponentToPrint extends React.Component {
  render() {
    {
      console.log("slum props", this.props.slum);
    }
    return (
      <div>
                ...
                <div className={styles.two}>
                  ...
                  <div className={styles.date5}>
                    <div className={styles.date6}>
                      <h4>
                        {" "}
                        <b>Self-Declaration for Self-Attestation </b>
                      </h4>{" "}
                    </div>
                  </div>
                  ...
                  <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                    <div className={styles.date2}>
                      <p style={{ marginLeft: "80px", marginRight: "70px" }}>
                        I am{" "}
                        {`${this.props?.hutOwnerData?.firstName} 
                  ${this.props?.hutOwnerData?.middleName} 
                  ${this.props?.hutOwnerData?.lastName}`}
                        .. Son/Daughter of Mr.
                        {`${this.props?.hutOwnerData?.middleName} 
                   ${this.props?.hutOwnerData?.lastName} `}
                        Age {this.props?.hutOwnerData?.age} year, Adhar
                        ...
                        hereby declares that, Self attested copies of the
                        prescribed proofs to verify eligibility in Slum
                        Rehabilitation Scheme are the original documents only.
                        If found to be false, I am fully aware that I will be
                        prosecuted and liable to punishment under the Indian
                        Penal Code and/or relevant laws.
                      </p>{" "}
                    </div>
                  </div>
                  <div
                ...
                <div className={styles.two}>
                  ...
                  <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                    <div className={styles.date2}>
                      <p style={{ marginLeft: "80px", marginRight: "70px" }}>
                        मी{" "}
                        {`${this.props?.hutOwnerData?.firstNameMr} 
                ${this.props?.hutOwnerData?.middleNameMr} 
                ${this.props?.hutOwnerData?.lastNameMr}`}
                        .. श्री.
                        {`${this.props?.hutOwnerData?.middleNameMr} 
                 ${this.props?.hutOwnerData?.lastNameMr} `}
                        ...
                        केलेल्या प्रती या मूळ कागपत्रांच्याच सत्य प्रती आहेत.
                        त्या खोट्या असल्याचे आढळून आल्यास, भारतीय दंड संहिता
