...
import schema from "../../../../containers/schema/newsRotationManagementSystem/masters/advertisementType"
...
const Index = () => {
  ...
  const getData = (
    ...
    axios
      ...
      .then((r) => {
        console.log(";r", r)
        let _res = r.data.advertisementType.map((r, i) => {
          return {
            ...r,
            srNo: i + 1,
          }
  ...
  const onSubmitForm = (fromData) => {
    ...
    setIsLoading(true)
    axios
      .post(`${urls.NRMS}/advertisementType/save`, _body, {
        headers: {
          Authorization: `Bearer ${userToken}`,
        },
      })
      ...
      swal({
        ...
        if (willDelete === true) {
          ...
          axios
            ...
            .post(`${urls.NRMS}/advertisementType/save`, body, {
              headers: {
                Authorization: `Bearer ${userToken}`,
              },
            })
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: <FormattedLabel id="advertisementTypeMr" />,
      flex: 2,
    },
    {
      field: "actions",
                    ...
                    >
                      ...
                      >
                        <Transliteration
                          ...
                          _key={"advertisementType"}
                          required
                          labelName={<FormattedLabel id="advertisementType" />}
                          fieldName={"advertisementType"}
                          updateFieldName={"advertisementTypeMr"}
                          sourceLang={"eng"}
                          targetLang={"mar"}
                          label={
                            <FormattedLabel id="advertisementType" required />
                          }
                          multiline
                          error={!!errors.advertisementType}
                          targetError={"advertisementTypeMr"}
                          InputLabelProps={{
                            style: { fontSize: 15 },
                            //true
                            shrink: watch("advertisementType") ? true : false,
                          }}
                          helperText={
                    ...
                    >
                      ...
                      >
                        <Transliteration
                          ...
                          _key={"advertisementTypeMr"}
                          required
                          labelName={
                            <FormattedLabel id="advertisementTypeMr" />
                          }
                          fieldName={"advertisementTypeMr"}
                          updateFieldName={"advertisementType"}
                          sourceLang={"mar"}
                          targetLang={"eng"}
                          label={
                            <FormattedLabel id="advertisementTypeMr" required />
                          }
                          multiline
                          error={!!errors.advertisementTypeMr}
                          targetError={"advertisementType"}
                          InputLabelProps={{
                            style: { fontSize: 15 },
                            //true
                            shrink: watch("advertisementTypeMr") ? true : false,
                          }}
                          helperText={
