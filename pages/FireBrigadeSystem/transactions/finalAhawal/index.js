...
import Form from "../../../FireBrigadeSystem/transactions/finalAhawal/form";
          ...
          <Box>
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                console.log("row action123", params.row);
                ("");
              }}
            >
              <Button
            ...
            {/* Approval Status */}
            {params.row.applicationStatus ===
            "CHEIF_FIRE_OFFICER_VERFICATION_COMPLETED" ? (
              <IconButton>
                <Button
                  size="small"
                  variant="contained"
              ...
              <IconButton>
                <Button
                  // style={{ paddingTop: isOpenCollapse ? "20px" : "0px" }}
                  style={{
                    color:
                      (params.row.applicationStatus ===
                  ...
                  onClick={() => {
                    ...
                    console.log("params.row123", params.row);
                    reset(params.row);
                    // setValue("serviceName", record.row.serviceId);
                    setApplicationData(params?.row);
                    setApplicationDataId(params?.row?.id);
                    setNewRole("FINAL_VERIFICATION");
                ...
                >
                  ...
                  {(params.row.applicationStatus ===
                    ...
                    params.row.applicationStatus === "PAYEMENT_SUCCESSFUL") &&
                    "Verified"}
                  {params.row.applicationStatus === "SENT_BACK_TO_DEPT_CLERK" &&
                    "Revert"}
                </Button>
              </IconButton>
            )}
