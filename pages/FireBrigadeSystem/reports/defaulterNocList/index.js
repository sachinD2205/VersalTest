  ...
  const getData = () => {
    ...
    axios
      .get(
        `${
          urls.FbsURL
        }/reports/getDefaulterNocListReport?fromDate=${formattedFromDate}&toDate=${formattedToDate}&serviceId=${getValues(
          "nameOfNoc"
        )}&applicationStatus=${getValues("applicationType")}
      `,
        {
          headers: {
            Authorization: `Bearer ${userToken}`,
          ...
          <Paper sx={{ padding: 2, backgroundColor: "#F2F3F4" }}>
            ...
            >
                ...
                >
                  ...
                  <Controller
                    render={({ field }) => (
                      ...
                      >
                        {serviceNames &&
                          serviceNames.map((nocItem, index) => (
                            // nocItem.nOCFor &&
                            <MenuItem key={index} value={nocItem.id}>
                              {language == "en"
                                ? nocItem.serviceName
                                : nocItem.serviceNameMr}
                            </MenuItem>
                          ))}
                      </Select>
                    )}
              ...
              <Grid item xs={3.5} className={styles.feildres}>
                ...
                >
                  <InputLabel id="demo-simple-select-standard-label">
                    <FormattedLabel id="applicationType" />
                  </InputLabel>
                  <Controller
                    render={({ field }) => (
                      <Select
                        ...
                        // disabled={router.query.pageMode == "View"}
                      >
                        <MenuItem value="Approval">Issued Noc</MenuItem>
                        <MenuItem value="PaymentPending">Pending Noc</MenuItem>
                        {/* <MenuItem value='3'>Final Building Fire NOC</MenuItem> */}
                      </Select>
                    )}
