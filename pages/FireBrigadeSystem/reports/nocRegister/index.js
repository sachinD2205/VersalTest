...
const validationSchema = yup.object({
  applicationType: yup
    ...
    .typeError("Application Type is required!"),
  nameOfNoc: yup
    .string()
...
const Index = () => {
  ...
  const getData = () => {
    ...
    let appStatus = getValues("applicationType");

    axios
      .get(`${urls.FbsURL}/reports/getDefaulterNocListReport?`, {
        params: {
                  ...
                  <Controller
                    render={({ field }) => (
                      ...
                      >
                        ...
                        <MenuItem value="PaymentPending">Received Noc</MenuItem>
