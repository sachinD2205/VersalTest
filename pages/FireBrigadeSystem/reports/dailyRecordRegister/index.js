...
const Index = () => {
  ...
  const getData = () => {
    ...
    axios
      .get(
        `${urls.FbsURL}/reports/getDailyRecordRegisterReport?fromDate=${moment(
          getValues("fromDate")
      ...
      .then((res) => {
        ...
        if (res?.status === 200) {
          ...
          if (
            res?.data?.occuranceRegister &&
            res.data.occuranceRegister.length > 0
          ) {
            setDisabledInputState(true);
            ...
            setDataSource(
              res?.data?.occuranceRegister?.map((r, i) => ({
                serialNo: i + 1,
  ...
  const columns = [
    ...
    {
      headerName: <FormattedLabel id="vehicleDetails" />,
    ...
    {
      headerName: <FormattedLabel id="timeOfIncident" />,
      field: "timeOfIncident",
      width: 140,
    },

    {
      headerName: <FormattedLabel id="causeOfFire" />,
      field: "causeOfFire",
      width: 200,
    },
    {
    ...
    {
      headerName: <FormattedLabel id="damageDetails" />,
      field: language == "en" ? "damageDetails" : "damageDetailsMr",
      width: 200,
    },

    {
      headerName: <FormattedLabel id="detailsDescriptionOfIncidentSite" />,
      field:
        language == "en"
          ? "detailsDescriptionOfIncidentSite"
          : "detailsDescriptionOfIncidentSiteMr",
