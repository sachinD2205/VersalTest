...
const Index = (props) => {
  ...
  useEffect(() => {
    // setPdata(props.data);
    console.log("Provisional NOC Props", this?.props);
  }, [props]);
  ...
  return (
    <>
      <div>
        <ComponentToPrint data={data} ref={componentRef} props={props} />
      </div>
            ...
            <table className={styles.headerTable1}>
              <tr>
                ...
                >
                  ...
                  >
                    Date:- {moment(applicationDate).format("DD-MM-YYYY")}
                    {/* <input
                      style={{
                        width: "60px",
                        border: "0px solid white",
            ...
            <div className={styles.reportContent}>
              ...
              >
                ...
                <table className={styles.Table1}>
                  ...
                  >
                    <h3>Token No:- {applicationNumber}</h3>
                  </td>
                  <td
                    style={{
                      fontSize: 12,
              ...
              >
                ...
                With reference to the application Date{" "}
                <b> {moment(applicationDate).format("DD-MM-YYYY")} </b>of the
                under mentioned applicant,{" "}
                <b>
                  "{this?.props?.props?.props?.applicantDTLDao?.applicantName}{" "}
                  {
                ...
                technical site inspection had been carried out by the concerned
                Officer of the fire department in accordance with the submitted
                plan copies and documents.
              </p>
              <p
                style={{
                  fontSize: 12,
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      <b>
                        {" "}
                        <td>20436.92 Sq Mtrs</td>
                      </b>
                    </tr>
                    <tr>
                      <b>
                        {" "}
                        <td> Permission FSI Area</td>
                      </b>

                      <td>
                        <b>39519.36 Sq.Mtrs</b>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              >
                ...
                {this?.props?.props?.props?.loi?.buildingNocApplicableCharagesDao?.map(
                  (r, i) => (
                    <>
                      <tr key={i}>
                        <td>{i + 1}</td>
                        ...
                        <td>
                          {
                            this?.props?.props?.props?.buildingDTLDao?.find(
                              (j) => j.id == r.buildingId
                            )?.floorDTLDao?.length
                          }
                        </td>
                ...
                <tbody>
                  ...
                  >
                    ...
                    >
                      ...
                      {this?.props?.props?.props?.buildingDTLDao?.buildingHeightH1}
              ...
              >
                <tr>
                  ...
                  >
                    <b>
                      IS-2309 Code for Protection of buildings against Lightning
                      Safety 1, 2, 4, 5, 6, 7, 8, 9 (b), 10 (a, c, i, j), 11,
                      12, 13, 14, 15, 16, 17, 20, 21, 22 (a, b), 23, 25, 26 (a,
                      c, e (iii)), 27, 28, 29 (a), 30, 31 (a, b), 32, 38, 39
                      Only.
                    </b>
                  </td>
                </tr>
                <tr>
                  ...
                  >
                    <b>
                      Subject to DP Opinion No. TPD/WS/Kiwale/Te.Kr.21/275/2016,
                      Dt.13/01/2016. As per Sanctioned note
                      Dt....................../2022 by Hon. Addl. Commissioner.
                    </b>
                  </td>
                </tr>
                <br></br>
