...
import { Box, Button, Card, Grid, IconButton, Link, Menu, MenuItem, Toolbar, Typography } from "@mui/material";
...
import { logout, setSelectedApplicationId, setUsersDepartmentDashboardData } from "../../features/userSlice";
...
const DepartmentDashboard = (props) => {
  ...
  const usersDepartmentDashboardData = useSelector((state) => {
    console.log("usersDepartmentDashboardData", state.user.usersDepartmentDashboardData);
  ...
  const ComponentWithIcon = ({ iconName }) => {
    ...
    return (
      <Icon
        style={{ fontSize: "80px", color: "orange", transition: "transform 0.1s" }}
          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 0 }}>
              ...
              >
                ...
                <MenuItem>
                  <Button size="small" sx={{ textTransform: "capitalize" }} onClick={handleLogout} variant="contained">
                    Logout
                  </Button>
                  <Button
                    size="small"
                      ...
                      <Card
                        ...
                        sx={{
                          ":hover": {
                            ...
                            background: "linear-gradient(to right, transparent 50%, #FFD494 50%)",
