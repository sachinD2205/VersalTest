...
const BachatGatCategory = () => {
      ...
      renderCell: (params) => {
        return (
          <>
            ...
            {bsupUserRoles.roleHOClerk && //loggedUser == "citizenUser" || loggedUser === "cfcUser" ||
            ...
            params.row.statusVal === 10 ? (
              ...
              >
                <Tooltip title={`Download Bachat Gat Certificate`}>
                  <CardMembershipIcon style={{ color: "#556CD6" }} />
                </Tooltip>
              </IconButton>
            ) : (
              <></>
  ...
  const setRemark = (isApprovedCheck) => {
    ...
    const tempData = axios
      .post(`${urls.BSUPURL}/trnBachatgatRegistration/save`, remarkData, {
        headers: headers,
      })
      .then((res) => {
        setIsLoading(false);
