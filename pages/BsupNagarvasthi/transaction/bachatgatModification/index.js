...
import bsupEnglishStatusLabel from "../../../../containers/reuseableComponents/labels/modules/bsupEnglishStatusLabel";
import bsupMarathiStatusLabel from "../../../../containers/reuseableComponents/labels/modules/bsupMarathiStatusLabel";
...
const BachatGatCategory = () => {
  ...
  }, [regDetails, language, zoneNames, wardNames, crAreaNames, statusAll]);
  ...
  const setRemark = (isApprovedCheck) => {
    ...
    for (var i = 0; i < regDetails.trnBachatgatRegistrationList.length; i++) {
      if (
        regDetails.trnBachatgatRegistrationList.find(
          (obj) => obj.id === selectedRows[i]
        )
      ) {
        let abc = regDetails.trnBachatgatRegistrationList.find(
          (obj) => obj.id === selectedRows[i]
        );
        const abcd = { ...abc };
        (abcd.isApproved =
                      ...
                      <Controller
                        ...
                        render={({ field: { onChange, value } }) => (
                          ...
                          >
                            ...
                            {bachatgatRevertCategories?.map((dept, index) => (
