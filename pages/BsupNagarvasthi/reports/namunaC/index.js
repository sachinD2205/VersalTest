...
const Index = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: language == "en" ? "Namuna C" : "नमुना क",
  });
            ...
            if (res?.data.length > 0) {
              ...
              setEngReportsData(
                res?.data?.map((r, i) => ({
                  ...
                  "Reason For Non Eligible": r.reasonForNonEligible,
                }))
              );
              ...
              setMrReportsData(
                res?.data?.map((r, i) => ({
                  ...
                  "अपात्रतेचे कारण": r.reasonForNonEligible,
                }))
              );
              setLoading(false);
            } else {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName:
        language == "en" ? "Reason For Non Eligible" : "अपात्रतेचे कारण",
      width: 100,
      headerAlign: "center",
      align: "center",
    },
  ...
  function generateCSVFile(data) {
    ...
    const fileName = language == "en" ? "Namuna C" : "नमुना क";
    let col = () => {};
    col();
    const fileType =
    ...
    ws.F4 = {
      t: "s",
      v: language == "en" ? `Report Name: Namuna C` : `अहवालाचे नाव: नमुना क`,
      s: dataStyle,
    };
    ws.F5 = {
      t: "s",
  ...
  function generatePDF(data) {
    ...
    doc.save(language == "en" ? "Namuna C.pdf" : "नमुना क.pdf");
  }
