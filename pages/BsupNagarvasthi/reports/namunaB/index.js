...
const Index = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: language == "en" ? "Namuna B" : "नमुना ब",
  });
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: language == "en" ? "IFSC No" : "आय.एफ.एस.सी क्र.",
      width: 90,
      headerAlign: "center",
      align: "center",
    },
  ...
  function generateCSVFile(data) {
    ...
    const fileName = language == "en" ? "Namuna B" : "नमुना ब";
    let col = () => {};
    col();
    const fileType =
    ...
    ws.F4 = {
      t: "s",
      v: language == "en" ? `Report Name: Namuna B` : `अहवालाचे नाव: नमुना ब`,
      s: dataStyle,
    };
    ws.F5 = {
      t: "s",
  ...
  function generatePDF(data) {
    ...
    doc.save(language == "en" ? "Namuna B.pdf" : "नमुना ब.pdf");
  }
