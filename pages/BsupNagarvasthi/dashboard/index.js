...
import NewSchemeFilterData from "./newSchemeFilterData";
import BachatgatFilterData from "./bachatgatFilterData";
...
const Index = () => {
  ...
  const [selectedDashboard, setSelectedDashboard] = useState("newSchemeApplication");
