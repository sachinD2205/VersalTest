...
import { PropertyStatusSchema } from "../../../../components/waterTax/schema/propertyStatus";
...
const Index = () => {
  ...
  const methods = useForm({
    criteriaMode: "all",
    resolver: yupResolver(PropertyStatusSchema(language)),
    mode: "onChange",
    defaultValues: {
      id: null,
      fromDate: null,
  ...
  const getConsumerCategory = (_pageSize = 10, _pageNo = 0) => {
    ...
    axios
      .get(`${urls.WTURL}/master/propertyStatus/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
        },
      ...
      .then((res) => {
        if (res?.status == 200 || res?.status == 201) {
          ...
          let response = res?.data?.propertyStatus;
          ...
          let _res = response.map((r, i) => {
            return {
              ...
              propertyStatusMr: r?.propertyStatusMr,
              toDate: r?.toDate,
              fromDate: r?.fromDate,
              toDate1:
              r?.toDate
  ...
  const onSubmitForm = (fromData) => {
    ...
    axios
      .post(`${urls.WTURL}/master/propertyStatus/save`, finalBodyForApi)
      .then((res) => {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      ...
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.WTURL}/master/propertyStatus/save`, body)
            .then((res) => {
  ...
  const columns = [
    ...
    {
      field: language == "en" ? "propertyStatus" : "propertyStatusMr",
      headerName: <FormattedLabel id="propertyStatus" />,
      description: <FormattedLabel id="propertyStatus" />,
      width: 240,
      flex: 3,
                        ...
                        <Grid container style={{ marginBottom: "7vh" }}>
                          ...
                          >
                            <Translation
                              ...
                              updateFieldName={"propertyStatusMr"}
                              sourceLang={"en-US"}
                              targetLang={"mr-IN"}
                            />
                          </Grid>
                          ...
                          >
                            <Translation
                              ...
                              width={270}
                              error={!!errors?.propertyStatusMr}
                              helperText={
                                errors?.propertyStatusMr
                                  ? errors?.propertyStatusMr?.message
                                  : null
                              }
                              key={"propertyStatusMr"}
                              fieldName={"propertyStatusMr"}
                              updateFieldName={"propertyStatus"}
                              sourceLang={"mr-IN"}
                              targetLang={"en-US"}
                            />
                          </Grid>
