...
import { BusinessSubTypeSchema } from "../../../../components/waterTax/schema/consumerCategory";
...
const Index = () => {
  ...
  const columns = [
...

    {
      ...
      description: <FormattedLabel id="categoryName" />,
      width: 240,
      flex: 3,
          ...
          <Paper className={ItemMasterCSS.Paper} elevation={5}>
            <ThemeProvider theme={theme}>
              <div className={ItemMasterCSS.MainHeader}>
                {<FormattedLabel id="consumerCategory" />}
              </div>
              {isOpenCollapse && (
                <Slide
                  direction="down"
                        ...
                        <Grid container style={{ marginBottom: "7vh" }}>
                          ...
                          >
                            <Translation
                              ...
                              updateFieldName={"categoryNameMr"}
                              sourceLang={"en-US"}
                              targetLang={"mr-IN"}
                            />
                          </Grid>
