          ...
          let _res = result.map((val, index) => {
            return {
              ...
              role:
                val.role == 1
                  ? "ADMIN"
                  : roleList.find((r) => r.id == val.role)?.name,
              menu: val.menu,
              user: val.user,
            };
          });
          ...
          >
            ...
            >
              <Button
                ...
                // disabled={load}
                disabled={
                  watch("applicationName") != 0 && !watch("applicationName")
                }
                variant="contained"
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="center">
                  {language == "en" ? "Menu Type" : "मेनू प्रकार"}
                </StyledTableCell>
                <StyledTableCell align="left">
                  {language == "en" ? "Menu Name" : "मेनूचे नाव"}
                </StyledTableCell>
                <StyledTableCell align="left">
                  {language == "en" ? "Role" : "भूमिका"}
                </StyledTableCell>
                <StyledTableCell align="center">
                  {language == "en" ? "Action" : "क्रिया"}
                </StyledTableCell>
              ...
              <Grid container>
                ...
                >
                  <Autocomplete
                    ...
                    renderInput={(params) => (
                      <TextField variant="outlined" {...params} label="Roles" />
                    )}
                  />
                </Grid>
              </Grid>
