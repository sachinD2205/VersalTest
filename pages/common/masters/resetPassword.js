...
const ResetPassword = () => {
  ...
  const onFinish = (values) => {
    ...
    axios
      .post(`${urls.CFCURL}/transaction/citizen/changeCitizenPassword`, body, {
        headers: {
      ...
      .then((r) => {
        ...
        if (r.status == 200) {
          if (
            ...
            return;
          } else if (r.data.message == "OLD PASSWORD IS WRONG") {
            toast("Wrong Old Password", {
              type: "error",
            });
            return;
          } else if (r.data.message == "INTERNAL SERVER ERROR") {
