...
const Index = () => {
  ...
  const getZoneAndWard = (
    ...
    setOpen(true);
    axios
      .get(`${urls.CFCURL}/master/zoneAndWardLevelMapping/getAll`, {
        params: {
          pageSize: _pageSize,
          pageNo: _pageNo,
          sortBy: _sortBy,
        ...
        if (res.status == 200) {
          ...
          let _res = result.map((val, i) => {
            return {
              ...
              zoneNumber: val.zone ? val.zone : "-",
              wardNumber: val.ward ? val.ward : "-",
              ...
              applicationCol: applicationList.find(
                ...
                ? applicationList.find((f) => f.id == val.application)
                    ?.applicationNameEng
                : "-",
            };
          });
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post(`${urls.CFCURL}/master/zoneAndWardLevelMapping/save`, bodyForAPI, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
