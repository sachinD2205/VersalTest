...
const Index = (props) => {
  ...
  const handlePay = () => {
    ...
    sweetAlert({
      ...
      if (willDelete) {
        if (cfcDetails?.balanceAvailableRs < showData?.rentAmount) {
          sweetAlert({
            ...
            if (res) {
              // router.push("./common/transactions/topUpProcess");
              router.push({
          ...
          axios
            ...
            .then((res) => {
              console.log("omkar", { ...router?.query }, router, res);
  ...
  const addToCfcBalanceHistory = () => {
    ...
    const finalBody = {
      ...
      paymentAmount: showData?.rentAmount,
              ...
              <tr className={styles.__tr}>
                ...
                <td className={styles.__tdAmt}>
                  <b>
                    ...
                    {showData && number2words(showData?.rentAmount)} रु (18% GST
                    (CGST + SGST))
                  </b>
                </td>
              </tr>
              <tr className={styles.__tr}>
                ...
                <td className={styles.__tdAmt}>
                  <b>
                    ...
                    {showData?.rentAmount} रु (18% GST (CGST + SGST))
                  </b>
                </td>
              </tr>
            </table>
