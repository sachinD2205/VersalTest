import { Button, Grid, Tooltip, Modal, Typography, IconButton,TextareaAutosize } from "@mui/material";
                    ...
                    meterReadingData.map((each, i) => (
                      <tr key={i}>
                        ...
                        <td style={{width:"10%" ,textAlign: "end"}}>
                          {each?.amountToBePaid?.toString().includes('.') ? each?.amountToBePaid : `${each?.amountToBePaid}.00`}
                        </td>
                      </tr>
                    ))}
          ...
          >
            <div className={modalStyles.boxRemark}>
              <div className={modalStyles.titlemodelremarkAprove}>
                ...
                <IconButton>
                  <CloseIcon
                    onClick={() =>  setmodalforAprov(false) }
                  />
                </IconButton>
              </div>

              <div className={modalStyles.btndate} style={{ marginLeft: '200px' }}>
                <TextareaAutosize
