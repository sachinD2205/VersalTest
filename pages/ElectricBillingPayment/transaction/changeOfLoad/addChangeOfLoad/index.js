...
const Index = () => {
  ...
  useEffect(() => {
    ...
    setValue("oldLoadTypeKey", _res?.loadTypeKey ? _res?.loadTypeKey : "");
    setValue("oldPhaseKey", _res?.phaseKey ? _res?.phaseKey : "");
    setValue("oldSlabTypeKey", _res?.slabTypeKey ? _res?.slabTypeKey : "");
    setValue("oldUsageTypeKey", _res?.usageTypeKey ? _res?.usageTypeKey : "");
    setValue(
    ...
    setValue(
      "oldConnectedLoad",
      _res?.connectedLoad ? _res?.connectedLoad : ""
    );
    setValue(
      "oldContractDemand",
  ...
  // get data for junior eng, deputy eng, exe eng, and acc dropdown
  ...
  const onSubmitForm = (formData) => {
    ...
    let _formData = {
      ...
      reasonForChangeOfLoad: formData?.reasonForChangeOfLoad,
      docForChangeOfLoad: referalDocument,
    };
      ...
      .then((res) => {
        if (res.status == 201) {
          ...
          sweetAlert(
            ...
            language === "en"
              ? "Load Changed Successfully !"
              : "लोड यशस्वीरित्या बदलले !",
            "success",
            { button: language === "en" ? "Ok" : "ठीक आहे" }
          );
          router.push(
  ...
  const handleClearButton = (e) => {
    setValue("consumptionTypeKey", null);
    setValue("loadTypeKey", null);
    setValue("phaseKey", null);
    setValue("slabTypeKey", null);
    setValue("usageTypeKey", null);
    setValue("msedclCategoryKey", null);
    setValue("msedclDivisionKey", null);
    setValue("billingUnitKey", null);
    setValue("subDivisionKey", null);
    setValue("sanctionedLoad", null);
    setValue("sanctionedDemand", null);
    setValue("connectedLoad", null);
    setValue("contractDemand", null);
    setValue("billingCycleKey", null);
    setValue("reasonForChangeOfLoad", null);
    // discard(e);
  };
                  ...
                  <AccordionDetails>
                    <Grid container spacing={2} sx={{ padding: "1rem" }}>
                      ...
                      >
                        ...
                        />
                        {/* <span><p color="danger"><FormattedLabel id="referalDocumentValidation" /></p></span> */}
                      </Grid>
