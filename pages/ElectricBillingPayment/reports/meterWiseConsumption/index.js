...
const Index = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "Meter Wise Consumtion Report",
  });
            ...
            if (res?.data.length > 0) {
              setData(
                res?.data?.map((r, i) => ({
                  ...
                  loadType: !loadTypeDropDown?.find((obj) => {
                    return obj.id == r?.loadTypeKey;
                  })
                    ? "-"
                    : loadTypeDropDown.find((obj) => {
                        return obj.id == r?.loadTypeKey;
                      }).loadType,
                  loadTypeMr: !loadTypeDropDown?.find((obj) => {
                    return obj.id == r?.loadTypeKey;
                  })
                    ? "-"
                    : loadTypeDropDown.find((obj) => {
              ...
              setEngReportsData(
                res?.data?.map((r, i) => ({
                  ...
                  "Division Name": !divisionDropDown?.find((obj) => {
                    return obj.id == r?.divisionKey;
                  })
                    ? "-"
                    : divisionDropDown.find((obj) => {
                  ...
                  "Load Type": !loadTypeDropDown?.find((obj) => {
                    return obj.id == r?.loadTypeKey;
                  })
                    ? "-"
                    : loadTypeDropDown.find((obj) => {
              ...
              setMrReportsData(
                res?.data?.map((r, i) => ({
                  ...
                  "लोड प्रकार": !loadTypeDropDown?.find((obj) => {
                    return obj.id == r?.loadTypeKey;
                  })
                    ? "-"
                    : loadTypeDropDown.find((obj) => {
  ...
  function generateCSVFile(data) {
    ...
    ws.B4 = {
      ...
      v:
        language == "en"
          ? `Report Name: Meter Wise Consumption Report`
          : `अहवालाचे नाव: मीटरनिहाय उपभोग अहवाल`,
    };
    ws.B5 = {
      t: "s",
      v:
