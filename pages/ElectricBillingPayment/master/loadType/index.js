                ...
                <Grid container>
                  ...
                  >
                    <Transliteration
                      _key={"loadType"}
                      fieldName={"loadType"}
                      updateFieldName={"loadTypeMr"}
                      sourceLang={"eng"}
                      targetLang={"mar"}
                      label={<FormattedLabel id="loadTypeEn" required />}
                      error={!!errors.loadType}
                      targetError={"loadTypeMr"}
                      width={230}
                      InputLabelProps={{
                        style: { fontSize: 15 },
                        //true
                  ...
                  >
                    <Transliteration
                      _key={"loadTypeMr"}
                      fieldName={"loadTypeMr"}
                      updateFieldName={"loadType"}
                      sourceLang={"mar"}
                      targetLang={"eng"}
                      label={<FormattedLabel id="loadTypeMr" required />}
                      error={!!errors.loadTypeMr}
                      targetError={"loadType"}
                      textFieldMargin={1}
                      width={230}
                      InputLabelProps={{
                        style: { fontSize: 15 },
