                ...
                <Grid container>
                  ...
                  >
                    <Transliteration
                      ...
                      sourceLang={"eng"}
                      targetLang={"mar"}
                      label={<FormattedLabel id="meterStatusEn" required />}
                      error={!!errors.meterStatus}
                      targetError={"meterStatusMr"}
                      width={230}
                      InputLabelProps={{
                        style: { fontSize: 15 },
                        //true
                      ...
                      textFieldMargin={1}
                      helperText={
                        errors?.meterStatus ? errors.meterStatus.message : null
                      }
                    />
                  </Grid>
                  ...
                  >
                    <Transliteration
                      ...
                      sourceLang={"mar"}
                      targetLang={"eng"}
                      label={<FormattedLabel id="meterStatusMr" required />}
                      error={!!errors.meterStatusMr}
                      targetError={"meterStatus"}
                      textFieldMargin={1}
                      width={230}
                      InputLabelProps={{
                        style: { fontSize: 15 },
