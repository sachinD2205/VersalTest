...
const Index = () => {
          ...
          let _res =
            ...
            result.map((r, i) => {
              return {
                ...
                divisionKey:
                  division &&
                  division.find((each) => each.id == r.divisionKey)?.id,
                divisionKeyMR:
                  division &&
                  division.find((each) => each.id == r.divisionKey)?.id,
                divisionKey1:
                  division &&
                  division.find((each) => each.id == r.divisionKey)?.division,
                divisionKeyMR1:
                  division &&
                  division.find((each) => each.id == r.divisionKey)?.divisionMr,
                id: r.id,
  ...
  const columns = [
    ...
    {
      field: language === "en" ? "divisionKey1" : "divisionKeyMR1",
                ...
                <Grid container>
                  ...
                  >
                    <FormControl
                      ...
                      sx={{ width: "50%" }}
                    >
                      <InputLabel shrink={!!watch("divisionKey")}>
                      ...
                      <Controller
                        render={({ field }) => (
                          <Select
                            variant="standard"
                            value={field.value} // Should be the ID of the selected division, not the name
                            onChange={(value) => field.onChange(value)}
                            label="Division"
                          >
                            {console.log("division", field)}
                            {/* {division.map((auditorium, index) => (
                              <MenuItem key={index} value={auditorium.id}>
                                {language === "en"
                                  ? auditorium.division
                                  : auditorium.divisionMr}
                              </MenuItem>
                            ))} */}
                  ...
                  >
                    <Transliteration
                      ...
                      updateFieldName={"subDivisionMr"}
                      sourceLang={"eng"}
                      targetLang={"mar"}
                      label={<FormattedLabel id="subDivisionEn" required />}
                      error={!!errors.subDivision}
                      targetError={"subDivisionMr"}
                      width={230}
                      InputLabelProps={{
                        style: { fontSize: 15 },
                        //true
                  ...
                  >
                    <Transliteration
                      _key={"subDivisionMr"}
                      fieldName={"subDivisionMr"}
                      updateFieldName={"subDivision"}
                      sourceLang={"mar"}
                      targetLang={"eng"}
                      label={<FormattedLabel id="subDivisionMr" required />}
                      error={!!errors.subDivisionMr}
                      targetError={"subDivision"}
                      textFieldMargin={1}
                      width={230}
                      InputLabelProps={{
                        style: { fontSize: 15 },
                      ...
                      helperText={
                        errors?.subDivisionMr
                          ? errors.subDivisionMr.message
                          : null
                      }
                    />
                  </Grid>
