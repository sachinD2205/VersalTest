...
const Index = () => {
  ...
  const getStoreTypes = () => {
    axios.get(`${urls.SSLM}/mstStoreTypes/getAll`).then((r) => {
      setStoreTypes(
        r.data.mstStoreTypesDao.map((row, i) => ({
      ...
      .then((r) => {
        ...
        let _res = result.map((r, i) => {
          ...
          return {
            ...
            // slab: r.slab,
            storeType: storeTypes?.find((item) => item.id == r.storeTypesKey)?.storeType,
                ...
                >
                  ...
                  <Grid item
                    ...
                    >
                      ...
                      />
                      <FormHelperText>
                        {errors?.storeTypesKey ? errors.storeTypesKey.message : null}
                      </FormHelperText>
                    </FormControl>
                  </Grid>
                  <Grid item
