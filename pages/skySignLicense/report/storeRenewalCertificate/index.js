...
import styles from "../../../../styles/skysignstyles/storeRenewalCertificate.module.css";
            ...
            <tr >
              <td className={styles.innerTableTd}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>व्यवसायाचे नाव : &nbsp;{this?.props?.dataa?.trnStoreDetailsDao?.nameOfStoreOrganization}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>व्यवसायाचा प्रकार : &nbsp;{this?.props?.dataa?.trnStoreDetailsDao?.storeType}</b>
                    </div>
                  </tr>
                  {/* <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
              ...
              <td className={styles.innerTableTd2}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b> व्यवसायाचे ठिकाण : &nbsp;{this?.props?.dataa?.trnStoreDetailsDao?.cityServrNumber + "," + this?.props?.dataa?.trnStoreDetailsDao?.roadName + "," + this?.props?.dataa?.trnStoreDetailsDao?.prCityName + "," + this?.props?.dataa?.trnStoreDetailsDao?.prState
                        + "," + this?.props?.dataa?.trnStoreDetailsDao?.pincode}</b>                      </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                    </div>
            ...
            <tr >
              <td className={styles.innerTableTd}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>एकूण मशिनरी : &nbsp;{this?.props?.dataa?.trnStoreDetailsDao?.machineCount}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>एकूण कर्मचारी : &nbsp;{this?.props?.dataa?.trnStoreDetailsDao?.totalEmployees}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
              ...
              <td className={styles.innerTableTd2}>
                <table>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>बांधकाम क्षेत्र :  &nbsp;</b>{this?.props?.dataa?.trnStoreDetailsDao?.constructionAreaM + " in sq.m"}
