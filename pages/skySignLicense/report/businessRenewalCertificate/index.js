...
import styles from "../../../../styles/skysignstyles/businessRenewalCertificate.module.css";
            ...
            <tr >
              <td className={styles.innerTableTd}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>व्यवसायाचे नाव : &nbsp;{this?.props?.dataa?.trnBussinessDetailsDao?.nameOfBusinessOrganization}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>व्यवसायाचा प्रकार : &nbsp;{this?.props?.dataa?.trnBussinessDetailsDao.businessType}</b>
                    </div>
                  </tr>
                  {/* <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
              ...
              <td className={styles.innerTableTd2}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b> व्यवसायाचे ठिकाण : &nbsp;{this?.props?.dataa?.trnBussinessDetailsDao?.cityServrNumber + "," + this?.props?.dataa?.trnBussinessDetailsDao?.roadName + "," + this?.props?.dataa?.trnBussinessDetailsDao?.prCityName + "," + this?.props?.dataa?.trnBussinessDetailsDao?.prState
                        + "," + this?.props?.dataa?.trnBussinessDetailsDao?.pincode}</b>                      </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                    </div>
