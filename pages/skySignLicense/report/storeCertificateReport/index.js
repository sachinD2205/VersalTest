                ...
                >
                  ...
                  <table className={styles.data}>
                    ...
                    <div style={{ marginTop: "5vh", marginBottom: "5vh", marginLeft: "5vh" }}>
                      ...
                      <tr>
                        <h3>
                          <b>स्टोअर चे नाव : &nbsp;{this?.props?.dataa?.trnStoreDetailsDao?.nameOfStoreOrganization}</b>
                        </h3>
                      </tr>
                      <tr> <h3>
                          ...
                          <right>
                            ...
                            <h3>
                              <b> व्यवसायाचे ठिकाण : &nbsp;{this?.props?.dataa?.trnStoreDetailsDao?.cityServrNumber + "," + this?.props?.dataa?.trnStoreDetailsDao?.roadName + "," + this?.props?.dataa?.trnStoreDetailsDao?.prCityName + "," + this?.props?.dataa?.trnStoreDetailsDao?.prState
                                + "," + this?.props?.dataa?.trnStoreDetailsDao?.pincode}</b>
                            </h3>
                            {/* <h3>
                            ...
                            <tr>
                              <div>
                                <right>
                                  ...
                                  <h3>
                                    {/* <b>पावती क्रमांक :  &nbsp;{this?.props?.dataa?.trnLoiDao?.trnPaymentCollectionDao[0]?.receiptNo}</b> */}
                                  </h3>
                                  <h3>
                                    {/* <b> फी भरल्याचा दिनांक :  &nbsp;{this?.props?.dataa?.trnLoiDao?.trnPaymentCollectionDao[0]?.receiptDate}</b> */}
                                  </h3>
                                </right>
