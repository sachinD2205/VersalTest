...
import styles from "../../../../styles/skysignstyles/industryCertificateFinal.module.css";
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>
                        व्यवसायाचे नाव : &nbsp;
                        {
                          this?.props?.dataa?.trnIndustryDetailsDao
                    ...
                    <div className={styles.detailLines}>
                      <b>
                        ...
                        {this?.props?.dataa?.trnIndustryDetailsDao
                          ?.cityServrNumber +
                          "," +
                          this?.props?.dataa?.trnIndustryDetailsDao?.roadName +
                          "," +
                          this?.props?.dataa?.trnIndustryDetailsDao
                            ?.prCityName +
                          "," +
                          this?.props?.dataa?.trnIndustryDetailsDao?.prState +
                          "," +
                          this?.props?.dataa?.trnIndustryDetailsDao?.pincode}
                      </b>{" "}
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                ...
                <table>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>
                        एकूण क्षेत्र : &nbsp;
                        {this?.props?.dataa?.trnIndustryDetailsDao?.totalAreaM +
                          " in sq.m"}
                      </b>
                    </div>
                  </tr>
