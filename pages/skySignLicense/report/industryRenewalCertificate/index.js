...
import styles from "../../../../styles/skysignstyles/industryRenewalCertificate.module.css";
        ...
        >
          <table className={styles.data}>
            ...
            <tr className={styles.upperDetails}>
              ...
              <div className={styles.detailLines}>
                <b>टोकन क्रमांक:-&nbsp;</b>{this?.props?.dataa?.applicationNumber}
              </div>
            ...
            <tr className={styles.upperDetails}>
              ...
              <div className={styles.detailLines}>
                <b>  टोकन दिनांक:-&nbsp;</b>{moment(this?.props?.dataa?.applicationDate).format('DD-MM-YYYY')}
              </div>
            ...
            <tr >
              <td className={styles.innerTableTd}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>परवाना कालावधी : &nbsp;{moment(this?.props?.dataa?.trnLicenseDao.licenseValidTill).format('DD-MM-YYYY')}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>व्यवसायाचे नाव : &nbsp;{this?.props?.dataa?.trnIndustryDetailsDao?.nameOfIndustryOrganization}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>व्यवसायाचा प्रकार : &nbsp;{this?.props?.dataa?.trnIndustryDetailsDao?.industryType}</b>
                    </div>
                  </tr>
                  {/* <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
              ...
              <td className={styles.innerTableTd2}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>  झोनचे नाव:-&nbsp;</b>{this?.props?.dataa?.trnLicenseDao.zoneKey}
                    </div>
                  </tr>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b> व्यवसायाचे ठिकाण : &nbsp;{this?.props?.dataa?.trnIndustryDetailsDao?.cityServrNumber + "," + this?.props?.dataa?.trnIndustryDetailsDao?.roadName + "," + this?.props?.dataa?.trnIndustryDetailsDao?.prCityName + "," + this?.props?.dataa?.trnIndustryDetailsDao?.prState
                        + "," + this?.props?.dataa?.trnIndustryDetailsDao?.pincode}</b>                      </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                    </div>
            ...
            <tr >
              <td className={styles.innerTableTd}>
                <table>
                  ...
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>अग्निशामक साधने : &nbsp;{this?.props?.dataa?.trnSiteVisitFormDao?.fireEquirepment == "true" ? "आहे" : "नाही"}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>एकूण मशिनरी : &nbsp;{this?.props?.dataa?.trnIndustryDetailsDao?.machineCount}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>एकूण कर्मचारी : &nbsp;{this?.props?.dataa?.trnIndustryDetailsDao?.totalEmployees}</b>
                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
              ...
              <td className={styles.innerTableTd2}>
                <table>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>बांधकाम क्षेत्र :  &nbsp;</b>{this?.props?.dataa?.trnIndustryDetailsDao?.constructionAreaM + " in sq.m"}

                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>प्रथमोपचार साधने :  &nbsp;</b>{this?.props?.dataa?.trnSiteVisitFormDao?.firstAidKit  == "true" ? "आहे" : "नाही"}

                    </div>
                  </tr>
                  <tr className={styles.rowCheck}>
                    <div className={styles.detailLines}>
                      <b>स्वच्छतागृह सोय :  &nbsp;</b>{this?.props?.dataa?.trnSiteVisitFormDao?.toilets  == "true" ? "आहे" : "नाही"}
            ...
            <tr>
              ...
              <tr>
                <div className={styles.rowCheck22}>
                  <b>(सदर परवाना हा महाराष्ट्र महानगरपालिका अधिनियम
                    व महानगरपालिकेचे उपविधी यांच्या शर्तीस अधिन
                    राहिल){" "}</b>
                </div>
                <div className={styles.rowCheck22}>
                  <b> 07/02/2020 च्या नोटराईज हमीपत्रामधील अटीस अधिन
                    राहून तात्पुरत्या स्वरूपाचा परवाना दिला असे{" "}</b>
                </div>
                <div className={styles.rowCheck22}>
                  <b>परवान्याची फी र.रू.:  &nbsp;</b>{this?.props?.dataa?.trnLoiDao?.amount}
                </div>
                <div className={styles.rowCheck22}>
                  <b>पावती क्रमांक :  &nbsp;</b>{this?.props?.dataa?.trnPaymentCollectionDao?.receiptNo}
                </div>
                <div className={styles.rowCheck22}>
                  <b> फी भरल्याचा दिनांक : &nbsp;</b>{moment(this?.props?.dataa?.trnPaymentCollectionDao?.receiptDate).format('DD-MM-YYYY')}
                </div>
            ...
            <tr>
              <ol className={styles.listDetails}>
                <li className={styles.listClass}>
                  {" "}
                  प्रत्येक परवाना धारकाने परवान्याचे नुतनीकरण दरवर्षी
                ...
                <li className={styles.listClass}>
                  {" "}
                  महानगरपालिकेच्या अधिका-याने परवाना तपासणीसाठी मागितला
                ...
                <li className={styles.listClass}>
                  {" "}
                  उद्योगधंद्यापासून निचरा होणारे पाणी रसायने अगर इतर
                ...
                <li className={styles.listClass}>
                  {" "}
                  महाराष्ट्र महानगरपालिका अधिनियम मधील कलमांचा व्यवसाय
                ...
                <li className={styles.listClass}>
                  {" "}
                  महानगरपालिका या कामी वेळोवळी जे नियम उपविधी करील व
                  परवाना शुल्क संबधी निर्णय घेईल ते परवाना धारकावर बंधनकारक
                  राहतील.
                </li>
                <li className={styles.listClass}>
                  {" "}
                  सदर परवान्या व्यतिरिक्त जे शासकीय / निमशासकीय परवाने
                  धारण करणे आवश्यक असतील असे सर्व परवाने धारण करणेची
                  जबाबदारी ही परवाना धारकावर राहील.
                </li>
                <li className={styles.listClass}>
                  {" "}
                  जाहिरात फलकाचा परवाना कालावधी संपल्यानंतर नुतनीकरण
                ...
                <li className={styles.listClass}>
                  {" "}
                  जाहिरात फलकाचे नुतनीकरण संपल्यानंतर किंवा मुदत
                  संपल्यानंतर सदरचा जाहिरात फलक संपुर्णपणे निष्कासित
                  करण्याची जबाबदारी माझी राहील.
                </li>
                <li className={styles.listClass}>
                  मनपाच्या विविध योजना व विविध उपक्रमाबाबत जाहिरात
