          ...
          <div className={styles.small}>
            ...
            <div>
              <h2 className={styles.heading}>
                <b>पावती</b>
                <h5>
                  (महाराष्ट्र आकाश चिन्ह परवाना व्यवस्थापन विनियमन स्टोअर परवाना
                  जारी करणे)
                </h5>
              </h2>
            </div>
              ...
              <p>
                <h5 style={{ marginLeft: "40px", marginRight: "40px" }}>
                  <b>
                    ...
                    <br />
                    स्टोअर परवाना जारी झालेल्याच्या दिनांक:{" "}
                    <b>
                      {" "}
                      {" " +
                        moment(
                    ...
                    आकाश चिन्ह परवाना व्यवस्थापन आकारण्यात येणारे स्टोअर परवाना
                    जारी करणे &nbsp;
                  </b>
                  <b>एकूण फी</b> &nbsp;
