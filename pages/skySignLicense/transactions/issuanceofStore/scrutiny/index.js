...
const Index = () => {
  ...
  // Get Table - Data
  const getIssuanceOfStoreDetails = () => {
    console.log("userToken", user.token);
    axios
      .get(
        `${urls.SSLM}/Trn/TrnIssuanceOfStoreLicense/getByServiceId?serviceId=9`,
        {
          headers: {
  ...
  const saveApproval = (body) => {
    axios
      .post(`${urls.SSLM}/Trn/TrnIssuanceOfStoreLicense/saveApprove`, body, {
        headers: {
          Authorization: `Bearer ${userToken}`,
        },
      })
                ...
                (authority?.includes("DOCUMENT_CHECKLIST") ||
                  ...
                  <IconButton
                    onClick={() =>
                      router.push({
                        pathname:
                          "/skySignLicense/transactions/issuanceofStore/scrutiny/scrutiny",
                        query: {
                          disabled: true,
                          ...record.row,
                  ...
                  <IconButton>
                    <Button
                      ...
                      onClick={() =>
                        router.push({
                          pathname:
                            "/skySignLicense/transactions/issuanceofStore/LoiGenerationComponent",
                          query: {
                            id: record.row.id,
                  ...
                  <IconButton>
                    <Button
                      ...
                      onClick={() =>
                        router.push({
                          pathname:
                            "/skySignLicense/transactions/issuanceofStore/PaymentCollection",
      ...
      >
        ...
        <div className={styles.detailsTABLE}>
          <div className={styles.h1TagTABLE}>
            ...
            >
              {" "}
              {<FormattedLabel id="storeLicense" />}
