...
const LoiGenerationComponent = (props) => {
  ...
  const getCharges = () => {
    let finalBodyForApi = {
      ...
      businessValue: tempBusinessValue,
    };
    setLoading(true);
    axios
      .post(
        `${urls.SSLM}/master/MstRateChartOfBusinessLicense/getRate`,
        finalBodyForApi,
        {
          headers: {
            Authorization: `Bearer ${userToken}`,
      ...
      .then((r) => {
        ...
        // setValue('serviceCharges', r.data.serviceCharge)
        // setServiceCharges(r.data.serviceCharge)
        setValue("businessTypesKey", r?.data?.businessTypesKey);
    ...
    axios
      ...
      .then((r) => {
        ...
        if (r.status === 200) {
          ...
          setTempBusinessType(r.data?.trnBussinessDetailsDao?.businessType);
          setTempBusinessValue(r.data?.trnBussinessDetailsDao?.businessValue);
          setValue(
            "businessValue",
            r.data?.trnBussinessDetailsDao?.businessValue
          );
        }
      })
      .catch((error) => {
  ...
  useEffect(() => {
    ...
    console.log(
      "tempBusinessTypetempBusinessValue",
      tempBusinessType,
      tempBusinessValue
    );
            ...
            >
              <Grid item xs={4} md={4} sm={4} xl={4} lg={4}>
                ...
                >
                  ...
                  />
                  <FormHelperText>
                    {errors?.businessTypesKey
                      ? errors.businessTypesKey.message
                      : null}
                  </FormHelperText>
                </FormControl>
              </Grid>
