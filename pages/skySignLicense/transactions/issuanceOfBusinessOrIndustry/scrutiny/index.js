...
const Index = () => {
  ...
  // Get Table - Data
  const getIssuanceOfBusinessDetails = () => {
    console.log("userToken", user.token);
    axios
      .get(
        `${urls.SSLM}/trnIssuanceOfBusinessLicense/getByServiceId?serviceId=7`,
        {
          headers: {
  ...
  const saveApproval = (body) => {
    axios
      .post(`${urls.SSLM}/trnIssuanceOfBusinessLicense/saveApprove`, body, {
        headers: {
          Authorization: `Bearer ${userToken}`,
        },
      })
