        ...
        >
          ...
          >
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.fireEquirepment"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.firstAidKit"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.toilets"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.storageofrawmaterial"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.disposalSystemOfWaste"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.nuisanceOfResidents"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.ObjectionCertificate"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnIndustryDetailsDao.separatebusiness"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
