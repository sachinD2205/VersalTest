...
const BusinessAndEmployeeDetails = (props) => {
  const {
    control,
    register,
    reset,
  ...
  useEffect(() => {
    console.log("abc12345", router.query,props);
  ...
  useEffect(() => {
    if (watch('trnBussinessDetailsDao.officeStaff') || watch('trnBussinessDetailsDao.permanentEmployees') || watch('trnBussinessDetailsDao.temporaryEmployees') || watch('trnBussinessDetailsDao.contractualEmployees') || watch('trnBussinessDetailsDao.totalEmployees')) {
      let tempTotal = 0;
      tempTotal = Number(watch('trnBussinessDetailsDao.officeStaff')) + Number(watch('trnBussinessDetailsDao.permanentEmployees')) + Number(watch('trnBussinessDetailsDao.temporaryEmployees')) + Number(watch('trnBussinessDetailsDao.contractualEmployees'))
      console.log("temptotal", tempTotal);
      setValue('trnBussinessDetailsDao.totalEmployees', Number(tempTotal))
    }

  }, [watch('trnBussinessDetailsDao.officeStaff'), watch('trnBussinessDetailsDao.permanentEmployees'), watch('trnBussinessDetailsDao.temporaryEmployees'), watch('trnBussinessDetailsDao.contractualEmployees'), watch('trnBussinessDetailsDao.totalEmployees')])
          ...
          >
            <Grid item xs={4} sm={4} md={4} lg={4} xl={4}>
              <TextField
                ...
                variant='standard'
                {...register("trnBussinessDetailsDao.officeStaff")}
            ...
            <Grid item xs={4} sm={4} md={4} lg={4} xl={4}>
              <TextField
                ...
                variant='standard'
                {...register("trnBussinessDetailsDao.permanentEmployees")}
            ...
            <Grid item xs={4} sm={4} md={4} lg={4} xl={4}>
              <TextField
                ...
                variant='standard'
                {...register("trnBussinessDetailsDao.temporaryEmployees")}
            ...
            <Grid item xs={4} sm={4} md={4} lg={4} xl={4}>
              <TextField
                ...
                variant='standard'
                {...register("trnBussinessDetailsDao.contractualEmployees")}
            ...
            <Grid item xs={4} sm={4} md={4} lg={4} xl={4}>
              <TextField
                ...
                variant='standard'
                {...register("trnBussinessDetailsDao.totalEmployees")}
        ...
        <div style={{ display: "flex", flexDirection: "row", alignItems: 'center' }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", width: '45vw', margin: "5vh" }}>
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.fireEquirepment"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.firstAidKit"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.toilets"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.storageofrawmaterial"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.disposalSystemOfWaste"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.nuisanceOfResidents"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.ObjectionCertificate"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
            ...
            <FormControl flexDirection="row">
              ...
              <Controller
                name="trnBussinessDetailsDao.separatebusiness"
                control={control}
                render={({ field }) => (
                  <RadioGroup
                    disabled={disabled}
...
export default BusinessAndEmployeeDetails;