...
const BusinessOrIndustryInfo = (props) => {
  ...
  const getownership = () => {
    axios.get(`${urls.CFCURL}/master/ownershipTypeMaster/getAll`).then((r) => {
      setownership(
  ...
  const getbusinessType = () => {
    axios.get(`${urls.CFCURL}/master/businessType/getAll`).then((r) => {
      setbusinessType(
  ...
  const getindustryType = () => {
    axios.get(`${urls.SSLM}/master/MstIndustryType/getAll`).then((r) => {
      setindustryType(
        ...
        >
          <Grid item xl={4} lg={4} md={4} sm={12} xs={12}>
            <TextField
              ...
              id="standard-basic"
              label={
                <FormattedLabel id="nameOfIndustryOrganization"></FormattedLabel>
              }
                    ...
                    {zone &&
                      zone.map((zone, index) => (
                        <MenuItem key={index} value={zone.id}>
                          ...
                          {language == "en" ? zone?.zoneEn : zone?.zoneMar}
                        </MenuItem>
                      ))}
                  </Select>
                )}
          ...
          <Grid item xl={4} lg={4} md={4} sm={12} xs={12}>
            <TextField
              ...
              label={
                <FormattedLabel id="businessLocationTotalCountOfMachineries"></FormattedLabel>
              }
              variant="standard"
              {...register(
                "trnIndustryDetailsDao.businessLocationTotalCountOfMachineries"
              )}
 ...
 */}
          ...
          >
            ...
            />
            <FormHelperText>
              {errors?.trnIndustryDetailsDao?.industryDate
                ? errors.trnIndustryDetailsDao.industryDate.message
                : null}
            </FormHelperText>
          </FormControl>
          ...
          >
            ...
            >
              ...
              />
              <FormHelperText>
                {errors?.trnIndustryDetailsDao?.temporarylicDate
                  ? errors.trnIndustryDetailsDao.temporarylicDate.message
                  : null}
              </FormHelperText>
            </FormControl>
          </Grid>
