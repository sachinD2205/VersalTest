...
import ScrutinyAction from "../../../skySignLicense/transactions/components/ScrutinyActionStore";
...
function getSteps() {
  return [
    ...
    <FormattedLabel key={5} id="storeInfo" />,
...
const LinaerStepper = () => {
  ...
  useEffect(() => {
    ...
    if (router.query.id) {
      axios
        .get(
          `${urls.SSLM}/Trn/TrnIssuanceOfStoreLicense/getApplicationById?appId=${router.query.id}`
        )
        .then((r) => {
  ...
  const handleNext = (data) => {
    ...
    if (activeStep == steps.length - 1) {
      axios
        .post(
          `${urls.SSLM}/Trn/TrnIssuanceOfStoreLicense/save`,
          data
          // {
          //   headers: {
          //     role: "CITIZEN",
            ...
            >
              ...
              {serviceId == 9 ? (
                <>
                  ...
                  <StoreInfo disabled={true} />
                  <StoreAndEmployeeDetails disabled={true} />
