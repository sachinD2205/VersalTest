...
const Index = () => {
  ...
  const onSubmitFunc = () => {
    if (watch("fromDate") && watch("toDate")) {
      ...
      setLoading(true);
      axios
        .post(`${urls.GM}/report/getEventWiseSummeryV4`, apiBodyToSend, {
          headers: {
            Authorization: `Bearer ${userToken}`,
          },
        })
            ...
            if (res?.data.length > 0) {
              ...
              let _enData = res?.data?.map((i, index) => {
                return {
                  ...
                  "Total Old Close Grievance": i?.totalOldCloseGrievance,
                  ...
                  "Completion Percentage(%)":
                    (
                      (i?.TotalCloseGrievance / i?.TotalGrievance) *
                      100
                    )?.toFixed(2) + " %",
                };
              });
              let _mrData = res?.data?.map((i, index) => {
                return {
                  ...
                  "कार्यक्रमाचे नाव": i?.mediaNameMr,
                  ...
                  "एकूण जुन्या बंद तक्रारी": i?.totalOldCloseGrievance,
  ...
  function generateCSVFile(data) {
    ...
    const reportName =
      language == "en" ? "Event Wise Summary" : "कार्यक्रमानुसार सारांश";
            ...
            <Paper elevation={3} style={{ margin: "10px", width: "80%" }}>
              <form onSubmit={handleSubmit(onSubmitFunc)}>
                ...
                >
                  ...
                  >
                    <FormControl sx={{ m: { xs: 0 }, minWidth: "100%" }}>
                      <Controller
                        control={control}
                        name="fromDate"
                        defaultValue={null}
          ...
          {reportData &&
            reportData?.map((reportData, index) => (
              <tr>
                ...
                <td className={gmReportLayoutCss.TableRows}>
                  {this?.props.language == "en"
                    ? reportData?.mediaName
                    : reportData?.mediaNameMr}
                </td>
                <td className={gmReportLayoutCss.TableRows}>
                  {this?.props.language == "en"
                    ? reportData?.areaName
