...
const Index = () => {
  ...
  const onSubmitFunc = () => {
    if (watch("fromDate") && watch("toDate")) {
      ...
      axios
        .post(
          `${urls.GM}/report/getReportDepartmentWisePendingSummeryV4`,
          apiBodyToSend,
          {
            headers: {
              Authorization: `Bearer ${userToken}`,
            ...
            if (res?.data.length > 0) {
              ...
              setData(
                res?.data?.map((r, i) => ({
                  ...
                  totalPendingGrievance: r.totalPendingGrievance,
              ...
              let _enData = res?.data?.map((i, index) => {
                return {
                  ...
                  "Total Pending Grievance": i?.totalPendingGrievance,
                  "Pending Percentage(%)": i.percentage + "%",
                };
              });
              let _mrData = res?.data?.map((i, index) => {
                return {
                  ...
                  "एकूण प्रलंबित तक्रार": i?.totalPendingGrievance,
                  "प्रलंबित टक्केवारी(%)": i.percentage + "%",
                };
              });
  ...
  const columns = [
    ...
    {
      field: "totalPendingGrievance",
      headerName: labels.totalPendingGrievance,
      minWidth: 150,
      headerAlign: "center",
      align: "center",
    },
    ...
    return (
      <>
        <table className={gmReportLayoutCss.table}>
          <tr>
            <td colSpan={10} className={gmReportLayoutCss.TableTitle}>
          ...
          <tr>
            ...
            <td className={gmReportLayoutCss.TableHeader}>
              {this?.props.language == "en"
                ? "Total Pending Grievance"
                : "एकूण प्रलंबित तक्रार"}
            </td>
            <td className={gmReportLayoutCss.TableHeader}>
              {this?.props.language == "en"
                ? "Pending Percentage(%)"
          ...
          {reportData &&
            reportData?.map((reportData, index) => (
              <tr>
                ...
                <td className={gmReportLayoutCss.TableRows}>
                  {this?.props.language == "en"
                    ? reportData?.totalPendingGrievance
                    : reportData?.totalPendingGrievance}
                </td>
                <td className={gmReportLayoutCss.TableRows}>
