...
const Index = () => {
  ...
  const onSubmitFunc = () => {
    if (watch("fromDate") && watch("toDate")) {
      ...
      setLoading(true);
      axios
        .post(`${urls.GM}/report/getReportPendingByEventV4`, apiBodyToSend, {
          headers: {
            Authorization: `Bearer ${userToken}`,
          },
        })
  ...
  function generateCSVFile(data) {
    ...
    const reportName = language == "en" ? "Pending By Event" : "कार्यक्रमाद्वारे प्रलंबित";
    ...
    const fileName =
      language === "en" ? "Pending By Event" : "कार्यक्रमाद्वारे प्रलंबित";
    let col = () => {};
    col();
    const fileType =
