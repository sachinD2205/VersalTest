...
const Index = () => {
            ...
            if (res?.data.length > 0) {
              ...
              let _enData = res?.data?.map((i, index) => {
                return {
                  ...
                  "Total Close Grievance": i?.totalCloseGriv,
                  "Total Open Grievance": i?.totalOpenGriv,
                  "Total Grievance": i?.totalGrievance,
                  "Completion Percentage(%)": i?.percentage,
                };
              });
              let _mrData = res?.data?.map((i, index) => {
                return {
                  ...
                  उपविभाग: i?.subDepartmentNameMr,
                  "क्षेत्राचे नाव": i?.areaNameMr,
                  "प्रभागाचे नाव": i?.wardNameMr,
                  "झोनचे नाव": i?.zoneNameMr,
                  "एकूण बंद तक्रार": i?.totalCloseGriv,
                  "एकूण खुली तक्रार": i?.totalOpenGriv,
                  "एकूण तक्रार": i?.totalGrievance,
                  "पूर्तता टक्केवारी(%)": i?.percentage,
                };
              });
  ...
  function generateCSVFile(data) {
    ...
    const reportName =
      language == "en" ? "Department Complaint Status" : "विभाग तक्रार स्थिती";
        ...
        <table className={gmReportLayoutCss.table}>
          ...
          <tr>
            <td className={gmReportLayoutCss.TableHeader}>
              {this?.props.language == "en" ? "Serial Number" : "अनुक्रमांक"}
            </td>
            <td className={gmReportLayoutCss.TableHeader}>
            ...
            <td className={gmReportLayoutCss.TableHeader}>
              {this?.props.language == "en" ? "Total Grievance" : "एकूण संख्या"}
            </td>
            <td className={gmReportLayoutCss.TableHeader}>
              {this?.props.language == "en"
          ...
          {reportData &&
            reportData?.map((reportData, index) => (
              <tr>
                ...
                <td className={gmReportLayoutCss.TableRows}>
                  {reportData?.totalCloseGriv}
                </td>
                <td className={gmReportLayoutCss.TableRows}>
                  {reportData?.totalOpenGriv}
                </td>
                <td className={gmReportLayoutCss.TableRows}>
