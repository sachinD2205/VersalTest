...
const Index = () => {
    ...
    axios
      ...
      .then((res) => {
        if (res?.status === 200 || res?.status === 201) {
          ...
          data.sort((a, b) => a.mediaTypeEn.localeCompare(b.mediaTypeEn));
          setMedias(data);
  ...
  const onSubmitFunc = () => {
    if (watch("fromDate") && watch("toDate")) {
      ...
      axios
        .post(
          `${urls.GM}/report/getReportDeptWiseApplicationSummaryV4`,
          apiBodyToSend,
          {
            headers: {
              Authorization: `Bearer ${userToken}`,
            ...
            if (res?.data.length > 0) {
              ...
              setData(
                res?.data?.map((r, i) => ({
                  ...
                  statusName: newFunctionForNullValues("en", r.statusName),
                  statusNameMr: newFunctionForNullValues("mr", r.statusNameMr),
                }))
              );
  ...
  function generateCSVFile(data) {
    ...
    const reportName =
      language == "en"
        ? "Department & Event wise Summary"
        : "विभाग आणि कार्यक्रमानुसार सारांश";
    ...
    const fileName =
      language === "en"
        ? "Dept & Event wise summary"
        : "विभाग & कार्यक्रमानुसार सारांश";
    let col = () => {};
    col();
    const fileType =
