      ...
      <CitizenDashboardData
        titleProp={
          language === "en"
            ...
            : "पिंपरी चिंचवड ऑनलाईन नागरीक पोर्टलवर आपले स्वागत आहे. "
        }
        subTitle={
          language === "en"
            ? " Welcome to Pimpri Chinchwad Online Citizen Portal, which is simple and convenient way for citizens to acess various services from anywhere at anytime. The service of virtual civic center can be accessed without paying any additional charges."
            : "पिंपरी चिंचवड ऑनलाइन नागरीक पोर्टलवर आपले स्वागत आहे, जे नागरिकांसाठी कोणत्याही वेळी कोठूनही विविध सेवांमध्ये प्रवेश करण्याचा सोपा आणि सोयीस्कर मार्ग आहे. कोणतेही अतिरिक्त शुल्क न भरता आभासी नागरी केंद्राच्या सेवेत प्रवेश करता येतो."
        }
      >
        <InnerCards pageKey={"dashboard"} />
      </CitizenDashboardData>
