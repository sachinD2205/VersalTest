      ...
      >
        ...
        <div className={styles.searchFilter}>
          ...
          >
            <InputLabel
              id="demo-simple-select-standard-label"
              //   disabled={router.query.zone ? true : false}
            >
              {/* <FormattedLabel id="zone" required /> */}
              {language === "en" ? "TDR Zone" : "टी डी आर झोन"}
            </InputLabel>
            <Controller
              render={({ field }) => (
                <Select
                  ...
                  labelId="demo-simple-select-standard-label"
                  id="demo-simple-select-standard"
                  value={router.query.zone ? router.query.zone : field.value}
                  onChange={(value) => field.onChange(value)}
                  label="zone"
                >
                  {zone &&
                  ...
                  {/* <MenuItem value={1}>शिपाई</MenuItem>
                  <MenuItem value={2}>अधियांता</MenuItem>
                  <MenuItem value={3}>कनिष्ठ अभियंता</MenuItem> */}
                </Select>
              )}
              name="zone"
              control={control}
              ...
              <table className={styles.report_table}>
                <thead>
                  ...
                  <tr>
                    ...
                    <th rowSpan={4} colSpan={1}>
                      {this?.props?.data?.language === "en" ? "Year" : "वर्ष"}
                    </th>
