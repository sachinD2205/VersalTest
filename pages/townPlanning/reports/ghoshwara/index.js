      ...
      >
        ...
        <div className={styles.searchFilter}>
            ...
            <Controller
              render={({ field }) => (
                <Select
                  ...
                  disabled={router.query.tDRZone ? true : false}
                  value={
                    router.query.tDRZone ? router.query.tDRZone : field.value
                  }
                  onChange={(value) => field.onChange(value)}
                  label="tDRZone"
                >
          ...
          <TextField
            ...
            sx={{ width: 230, marginTop: "2vh", marginLeft: "5vh" }}
            id="standard-basic"
            label="सर्वे क्रमांक"
              ...
              <table className={styles.report_table}>
                <thead>
                  ...
                  <tr>
                    ...
                    <th rowSpan={4} colSpan={1}>
                      {this?.props?.data?.language === "en" ? "Zone" : "प्रभाग"}
                    </th>
