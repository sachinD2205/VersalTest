...
const Index = () => {
  ...
  let schema = yup.object().shape({
    legend: yup.string().required(<FormattedLabel id="legendV" />),
                ...
                <Grid>
                  <Grid container sx={{ padding: "10px" }}>
                    ...
                    >
                      <Transliteration
                        variant={"outlined"}
                        _key={"reservationNameEn"}
                        labelName={"reservationNameEn"}
                        fieldName={"reservationNameEn"}
                        updateFieldName={"reservationNameMr"}
                        sourceLang={"eng"}
                        targetLang={"mar"}
                        label={
                    ...
                    >
                      <Transliteration
                        variant={"outlined"}
                        _key={"reservationNameMr"}
                        labelName={"reservationNameMr"}
                        fieldName={"reservationNameMr"}
                        updateFieldName={"reservationNameEn"}
                        sourceLang={"mar"}
                        targetLang={"eng"}
                        label={
