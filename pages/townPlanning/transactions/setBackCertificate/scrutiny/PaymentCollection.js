...
const Index = () => {
  ...
  useEffect(() => {
    axios
      .get(`${urls.CFCURL}/master/servicecharges/getByServiceId?serviceId=20`, {
        headers: {
  ...
  const handlePay = () => {
    ...
    const finalBody = {
      ...
      // role: "CASHIER",
      role: "LOI_COLLECTION",
      // paymentDetails: getValues("trnLoiDao"),
      // payment: getValues("payment"),
      //trnLoiDao: { mstServiceChargesId: 1 },

      paymentCollection: getValues("payment"),
    };
    // console.log("payyyyy",getValues("payment"));
    axios
      ...
      .then((res) => {
        console.log(res, "loi collection--");
  ...
  useEffect(() => {
    if (router?.query?.serviceId == 20) {
      axios
        ...
        .then((res) => {
          reset(res.data);
          setValue("totalAmount", res.data?.trnLoiDetails?.amount);
          setDataa(res.data);
            ...
            <div className={styles.date3}>
              ...
              <div className={styles.date3}>
                ...
                <h4 style={{ marginLeft: "10px" }}>
                  ...
                  {" " +
                    moment(
                      dataa?.trnLoiDetails?.createDtTm,
            ...
            <table id="table-to-xls" className={styles.report_table}>
              <thead>
                ...
                <tr>
                  ...
                  <td colSpan={4}>{dataa?.trnLoiDetails?.amount}/-</td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td colSpan={4}>
                    <b>एकूण रक्कम रुपये: {dataa?.trnLoiDetails?.amount}/-</b>
                  </td>
                </tr>
              </tbody>
            </table>
