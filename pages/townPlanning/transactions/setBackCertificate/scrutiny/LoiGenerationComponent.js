...
const LoiGenerationComponent = (props) => {
  ...
  // console.log("pppppppp",watch("mstServiceCharges.[0]"));
  useEffect(() => {
    getserviceNames();
  ...
  const handleNext = (data) => {
    let finalBodyForApi = {
      ...
      role: "LOI_GENERATION",
      // loi: null,
      trnLoiDao: { mstServiceChargesId: 4 },
      // serviceId: 20,

      id: Number(applicationId),
    };
    console.log("oooooooo", finalBodyForApi);
    if (serviceId == 20) {
      axios
        .post(
          ...
          >
            ...
            <Grid item xs={12} sm={6} md={4} lg={3} xl={2}>
              <TextField
                ...
                id="standard-basic"
                // disabled={inputState}
                label={<FormattedLabel id="surnameMr" />}
                {...register("surnameMr")}
          ...
          >
            ...
            <Grid item xs={3} md={3} sm={3} xl={3} lg={3}>
              <TextField
                ...
                {...register(`mstServiceCharges[${0}].certificateCharges`)}
                // error={!!errors.amount}
                // helperText={errors?.amount ? errors.amount.message : null}
              />
            </Grid>
