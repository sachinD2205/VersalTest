                  ...
                  <div className={styles.date3} style={{ marginRight: "5vh" }}>
                    ...
                    <h4 style={{ marginLeft: "10px" }}>
                      <b>
                        ...
                        {" " +
                          moment(
                            this?.props?.dataa?.paymentDetails?.receiptDate,
                            "YYYY-MM-DD",
                          ).format("DD-MM-YYYY")}
                      </b>{" "}
                ...
                <p>
                  <h5 style={{ marginLeft: "40px", marginRight: "40px" }}>
                    <b>
                      ...
                      <table id="table-to-xls" className={styles.report_table}>
                        <thead>
                          ...
                          <tr>
                            ...
                            <td colSpan={4}>
                              {this?.props?.dataa?.paymentDetails?.amount}
                            </td>
                          </tr>
                        </thead>
                        <tbody>
                      ...
                      {this?.props?.dataa?.serviceNameMr} पद्धतीने झालेल्याचा
                      दिनांक:{" "}
                      <b>
                        {" "}
                        {" " +
                    ...
                    <b> एकूण फी</b> &nbsp;
                    <b>{this?.props?.dataa?.paymentDetails?.amount} रु .</b>
                    <br />
                    <b>
