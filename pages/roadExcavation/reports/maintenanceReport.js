...
const index = () => {
  ...
  const finalSubmit = (data) => {
    ...
    axios
      .get(`${urls.RENPURL}/nocPermissionForMaintenance/getReportsByFromDtandToDate?fromDate=${fromDate}&toDate=${toDate}`, {
        headers: {
      ...
      .then((res) => {
        ...
        setTable(
          //have to add path 
          res.data?.nocPermissionForMaintenanceDaoList?.length > 0
            ? res.data.nocPermissionForMaintenanceDaoList.map((r, i) => ({
    ...
    <>
      ...
      <Paper className={styles.main}>
        <div className={styles.title}>
          ...
          <FormattedLabel id='maintenanceApplicationReport' />
        </div>
