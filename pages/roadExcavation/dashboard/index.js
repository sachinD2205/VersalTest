...
const Index = () => {
  ...
  const getMyApplications = async () => {
    ...
    axios
      .get(`${urls.RENPURL}/report/getTotalApplication`,{
        headers: {
          Authorization: `Bearer ${userToken}`,
        },
      })
    ...
    axios
      .get(`${urls.RENPURL}/report/getTotalApprovedApplication`,{
        headers: {
          Authorization: `Bearer ${userToken}`,
        },
      }
...
console.log("approveddd",resp);
    ...
    axios
      .get(`${urls.RENPURL}/report/getTotalRejectedApplication`,{
        headers: {
          Authorization: `Bearer ${userToken}`,
        },
      }
    ...
    axios
      .get(`${urls.RENPURL}/report/getTotalPendingApplication`,{
        headers: {
          Authorization: `Bearer ${userToken}`,
        },
      }
          ...
          <Grid container>
            ...
            <Grid item xs={12}>
              <h2 style={{ textAlign: "center", color: "#ff0000" }}>
                <b>
                  {language == "en"
                    ? "Road Excavation NOC Permission Dashboard"
                    : "रस्ता उत्खनन NOC परवानगी डॅशबोर्ड"}
                </b>
              </h2>
            </Grid>
            <Grid item xs={12}>
                  ...
                  >
                    <Chart
                      options={{
                        ...
                        labels: [ "Rejected Application","Approved Application", "Pending Application"],
                        responsive: [
                          {
                            breakpoint: 480,
                            options: {
                      ...
                      series={[rejectedApplication?.length,approvedApplication?.length,pendingApplication?.length ]}
