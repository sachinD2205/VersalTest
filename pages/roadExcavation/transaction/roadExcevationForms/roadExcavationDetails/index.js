...
const Index = () => {
  ...
  const [lodderState, setLodderState] = useState(false);
  ...
  console.log("authority1112", authority);
  ...
  const handleGenerateNOC = (paramsRow) => {
    ...
    const tempData = axios
      ...
      .then((res) => {
        setLodderState(false)
        if (res.status == 201 || res.status == 200) {
          sweetAlert("Saved!", "NOC Genrated Successfully !", "success");
          router.push({
            pathname: "/roadExcavation/transaction/documenstGeneration/NOC",
            query: {
              id: paramsRow.id,
            },
          });
            ...
            <Grid item xl={4} lg={4} md={4} sm={4} xs={4}>
              ...
              {authority &&
                ...
                (params.row.applicationStatus == "APPROVE_BY_DEPUTY_ENGINEER" ||
                  params.row.applicationStatus ==
                    "REVERT__BY_JOINT_CITY_ENGINEERR") && (
                  <>
                    <Button
                      variant="contained"
                      onClick={() => {
              ...
              {authority &&
                ...
                (params.row.applicationStatus ==
                  ...
                  params.row.applicationStatus ==
                    "REVERT_BY_ADDITIONAL_COMMISSIONER") && (
                  <>
                    <Button
                      variant="contained"
                      onClick={() => {
