...
const Index = () => {
  ...
  useEffect(() => {
    ...
    setTotalAmount( res?.trnLoiDao?.amount);
  }, [dataSource]);
    ...
    if (btnSaveText === "Save") {
      if (loggedInUser === "citizenUser") {
        const tempData = axios
          .post(
            `${urls.RENPURL}/nocPermissionForMaintenance/saveApprove`,
            body,
            {
              headers: {
                UserId: user.id,
            ...
            <div style={{ marginBottom: "50px" }}>
                            <table className={styles.table} style={{ marginTop: "30px" }}>
                                ...
                                <tr>
                                    <td className={styles.th}>
                                        {language == "en"
                                            ? natureofExcavation?.find(
                                                (data) =>
                                                    data?.id ==
                                                    dataSource?.natureOfExcavationMaintnance
                                            )?.nameEng
                                            : natureofExcavation?.find(
                                                (data) =>
                                                    data?.id ==
                                    ...
                                    <td className={styles.th}>
                                        {dataSource?.lengthOfRoadMaintenance}
                                    </td>
                                    <td className={styles.th}>
                                        100/-
                                    </td>
                                    <td className={styles.th}>
                                        {dataSource?.trnLoiDao?.amount}/-
                                    </td>
                                </tr>
                            </table>
                        </div>
