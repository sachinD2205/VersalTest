                ...
                <div >
                    ...
                    <div >
                        ...
                        <div style={{ margin: "80px", }}>
                            ...
                            <div >
                         {console.log(this.props.dataSource.applicantSubType,"applicantSubType")}
                         {this.props.dataSource.applicantSubType == 3 && 
                        <div style={{ marginBottom: "50px" }}>
                            <table className={styles.table} style={{ marginTop: "30px" }}>
                                ...
                                <tr>
                                    ...
                                    <td className={styles.th}>
                                        {this?.props?.dataSource?.trnLoiDao?.amount}/-
                                    </td>
                                </tr>
                            </table>
                        </div>
