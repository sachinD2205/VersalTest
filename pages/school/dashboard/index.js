...
const Index = () => {
  ...
  const getMyApplications = async () => {
    if (user?.id) {
      axios
        .get(
          `${urls.SCHOOL}/trnStudentAdmissionForm/getAllData?userId=${user?.id}`,
          {
            headers: {
      ...
      axios
        .get(
          `${urls.SCHOOL}/trnStudentAdmissionForm/approve?userId=${user?.id}`,
          {
            headers: {
              Authorization: `Bearer ${userToken}`,
            },
      ...
      axios
        .get(
          `${urls.SCHOOL}/trnStudentAdmissionForm/pending?userId=${user?.id}`,
          {
            headers: {
              Authorization: `Bearer ${userToken}`,
            },
      ...
      axios
        .get(
          `${urls.SCHOOL}/trnStudentAdmissionForm/rejected?userId=${user?.id}`,
          {
            headers: {
              Authorization: `Bearer ${userToken}`,
            },
              ...
              <h2 style={{ textAlign: "center", color: "#ff0000" }}>
                <b>
                  {language == "en"
                    ...
                    : "शाळा व्यवस्थापन प्रणाली डॅशबोर्ड"}
                </b>
              </h2>
            </Grid>
            <Grid item xs={12}>
