...
import { BusinessSubTypeSchema } from "../../../../components/streetVendorManagementSystem/schema/BusinessSubTypeSchema";
...
const Index = () => {
  ...
  const methods = useForm({
    criteriaMode: "all",
    resolver: yupResolver(BusinessSubTypeSchema(language)),
    mode: "onChange",
    defaultValues: {
      id: null,
    },
        ...
        if (res?.status == 200 || res?.status == 201) {
          ...
          let _res = response.map((r, i) => {
            return {
              ...
              businessTypeNameMr: businessTypes?.find(
                (obj) => obj?.id === r.businessTypeId
              )?.businessType,
              businessTypeNameEn: businessTypes?.find(
                (obj) => obj?.id === r.businessTypeId
              )?.businessTypeMr,
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${urls.HMSURL}/master/businessSubType/save`, body, {
              headers: {
                Authorization: `Bearer ${userToken}`,
              },
            }
                      ...
                      <form onSubmit={handleSubmit(onSubmitForm)}>
                        <Grid container style={{ marginBottom: "7vh" }}>
                          ...
                          >
                            ...
                            >
                              <InputLabel shrink={watch("applicationName") != null && watch("applicationName") != undefined && watch("applicationName") != "" ? true : false} id="demo-simple-select-standard-label">
                          ...
                          >
                            ...
                            >
                              <InputLabel shrink={watch("businessTypeId") != null && watch("businessTypeId") != undefined && watch("businessTypeId") != "" ? true : false} id="demo-simple-select-standard-label">
                          ...
                          >
                            ...
                            <Translation
                              ...
                              width={270}
                              // disabled={watch("businessSubTypeMr")}
                              error={!!errors?.businessSubTypeMr}
                              helperText={
                                errors?.businessSubTypeMr
                                  ? errors?.businessSubTypeMr?.message
