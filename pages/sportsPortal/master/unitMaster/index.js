...
import schema from "../../../../containers/schema/sportsPortalSchema/unitSchema";
...
const Index = () => {
    ...
    if (_activeFlag === "N") {
      ...
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(
              `${URLS.SPURL}/applicantType/saveFacilityName`,
              {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
  ...
  const columns = [
    ...
    {
      field: "unit",
      headerName: <FormattedLabel id="unitEn" />,
      width: 380,
      headerAlign: "center",
      align: "center",
      // width: "50px",
    ...
    {
      field: "unitMr",
      headerName: <FormattedLabel id="unitMr" />,
      width: 380,
      align: "center",
      headerAlign: "center",
    },
  ...
  return (
    <>
      ...
      >
        ...
        >
          <strong>{<FormattedLabel id="unitMaster" />}</strong>
        </div>
        {isOpenCollapse && (
                    ...
                    <div className={styles.row}>
                      <div>
                        <FormControl variant="standard" error={!!errors.unit}>
                          <TextField
                            id="standard-basic"
                            label={<FormattedLabel id="unitEn" />}
                      ...
                      <div>
                        <FormControl variant="standard" error={!!errors.unitMr}>
                          <TextField
                            id="standard-basic"
                          ...
                          />
                          <FormHelperText>
                            {errors?.unitMr ? errors.unitMr.message : null}
                          </FormHelperText>
                        </FormControl>
                      </div>
                    </div>
