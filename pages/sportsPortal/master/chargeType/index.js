...
const Index = () => {
  ...
  const onSubmitForm = (fromData) => {
    ...
    if (btnSaveText === "Save") {
      const tempData = axios
        .post(`${URLS.SPURL}/chargeType/save`, _body, {
          headers: {
  ...
  const deleteById = (value, _activeFlag) => {
    ...
    if (_activeFlag === "N") {
      ...
      swal({
        ...
        if (willDelete === true) {
          axios
            .post(`${URLS.SPURL}/chargeType/save`, body, {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            })
  ...
  const columns = [
...

    {
      ...
      headerName: <FormattedLabel id="chargeTypeEn" />,
      //type: "number",
      flex: 1,
    },
                    ...
                    <div className={styles.row}>
                      <div>
                        ...
                        <Transliteration
                          ...
                          variant="standard"
                          sx={{ width: 220 }}
                          label={<FormattedLabel id="chargeTypeEn" required />}
                          InputLabelProps={{
                      ...
                      <div>
                        ...
                        >
                          <TextField
                            ...
                            helperText={
                              errors?.facilityTypeId
                                ? "Facility Type Id  is Required !!!"
                                : null
                            }
                          />
                          <FormHelperText>
