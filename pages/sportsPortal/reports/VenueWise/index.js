...
function SportsBooking() {
  ...
  const getSportsBookingData = (
    ...
    axios
      ...
      .get(
        `${urls.SPURL}/report/getDataByFacilityTypeAndSubTypeAndVenueAndFromAndToDate`,
        {
          params: {
            facilityTypeId: watch("facilityType"),
            facilitySubTypeId: watch("facilityName"),
            venue: watch("venue"),
    ...
    <Paper>
                      ...
                      {facilityNames &&
                        facilityNames
                          .filter((facility) => {
                            ...
                            return (
                              facility.facilityType === watch("facilityType")
                            );
                          })
      ...
      <Box sx={{ paddingTop: "10px", paddingLeft: "180px" }}>
        <ReportLayout
          ...
          reportName={{
            en: "Sport Facility Venue Wise Register",
            mr: "क्रीडा सुविधा ठिकाणानुसार नोंदणी",
          }}
