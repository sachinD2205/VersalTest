      ...
      .then((res, i) => {
        ...
        let _res = result?.map((r, index) => {
          return {
            ...
            applicantName: r.firstName + " " + r.middleName + " " + r.lastName,
            venue: r.venue,
  ...
  return (
    <Paper>
      ...
      >
        ...
        >
          <h2>{language === "en" ? "Gym Details" : "जिम तपशील"}</h2>
          {/* <h2>Gym Details </h2> */}
        </Grid>
        <Grid
          item
              ...
              <FormControl style={{ marginTop: 10 }}>
                <Controller
                  ...
                  render={({ field }) => (
                    <LocalizationProvider dateAdapter={AdapterMoment}>
                      <DatePicker
                        minDate={watch("fromDateMembership")}
                        maxDate={new Date()}
                        inputFormat="DD/MM/YYYY"
                        label={
                          <span style={{ fontSize: 16 }}>
      ...
      <Grid container sx={{ display: "flex", justifyContent: "center" }}>
        <Button
          ...
          size="small"
          disabled={
            watch("fromDateMembership") == null ||
            watch("toDateMembership") == null
          }
          onClick={() => {
            getSportsBookingData(
              watch("fromDateMembership"),
              watch("toDateMembership"),
            );
          }}
        >
      ...
      <Box sx={{ paddingTop: "10px", paddingLeft: "180px" }}>
        <ReportLayout
          ...
          showDates
          date={{
            from: moment(watch("fromDateMembership")).format("DD/MM/YYYY"),
            to: moment(watch("toDateMembership")).format("DD/MM/YYYY"),
          }}
          deptName={{
            en: "Sports Portal",
            mr: "क्रीडा पोर्टल",
          ...
          reportName={{
            en: "GYM Membership Register",
            mr: "व्यायाम शाळा सदस्यत्व नोंदणी",
          }}
              ...
              <table className={styles.report}>
                ...
                <tbody>
                  <tr>
                    ...
                    <th colSpan={1}>
                      {this?.props?.data?.language === "en" ? "Status" : ""}
                    </th>
                    {/* <th colSpan={1}>
