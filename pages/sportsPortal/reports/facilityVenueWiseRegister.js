...
const Index = () => {
    ...
    resolver: yupResolver(
      yup.object().shape({
        venue: yup
          .number()
          .required(
            language == 'en' ? 'Please select a venue' : 'कृपया ठिकाण निवडा'
          )
          .typeError(
            language == 'en' ? 'Please select a venue' : 'कृपया ठिकाण निवडा'
          ),
  ...
  const finalSubmit = (data) => {
    ...
    axios
      .get(
        `${urls.SPURL}/report/getDataByVenueAndDurationTypeAndFromAndToDate`,
        {
          ...
          params: customSelection
            ...
            : { venue: data?.venue, durationType: data?.durationType },
        }
      )
      .then((res) => {
        const finalData = [
  ...
  return (
    <>
      ...
      <Paper className={styles.main}>
        <Title titleLabel={<FormattedLabel id='facilityVenueWiseRegister' />} />
        ...
        <form onSubmit={handleSubmit(finalSubmit)}>
          ...
          <div
            ...
            style={{ justifyContent: 'center' }}
          >
            <FormControl variant='standard' error={!!error.venue}>
                  ...
                  >
                    {venues?.map((j) => (
                      <MenuItem key={j?.id} value={j?.id}>
                        {language === 'en' ? j?.venueEn : j?.venueMr}
                      </MenuItem>
                    ))}
                  </Select>
                )}
