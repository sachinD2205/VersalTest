...
const SelfDeclarationSwimming = (props) => {
  const {
    control,
    register,
    getValues,
                  ...
                  <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                    <div className={styles.date2}>
                      <p style={{ marginLeft: "30px", marginRight: "30px" }}>
                        1) I am able to swim perfectly and I am coming to swim
                        at my own responsibility in the
                        <b>
                          {" "}
                          {
                        ...
                        pool of the Pimpri Chinchwad Municipal Corporation.
                        <br />
                        ...
                        swimming pool of Pimpri Chinchwad Municipal Corporation.
                        The information and certificate provided by me for
                        booking are true. I am aware that if the said
                      ...
                      >
                        <div className={styles.date2}>
                          <p style={{ marginLeft: "30px" }}>
                            ...
                            Date:-{" "}
                            <b>
                              {moment(watch("applicationDate")).format(
                                "DD-MM-YYYY"
                              )}
                            </b>{" "}
                          </p>
              ...
              <div className={styles.small}>
                <div className={styles.two}>
                  ...
                  <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                    <div className={styles.date2}>
                      <p style={{ marginLeft: "30px", marginRight: "30px" }}>
                        १) मला उत्तम प्रकारे पोहता येत असून मी पिंपरी चिंचवड
                        महानगरपालिकेच्या{" "}
                        <b>
                          {" "}
                          {
                        ...
                        येथील तलावात मी माझ्या जबाबदारीवर पोहण्यासाठी येत आहे.
                        <br />
                        ...
                        येथील जलतरण तलावात पोहण्यासाठी मी ऑनलाईन बुकींग केलेले
...
export default SelfDeclarationSwimming;
