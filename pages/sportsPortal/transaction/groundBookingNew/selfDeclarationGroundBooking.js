...
const SelfDeclarationGroundBooking = (props) => {
  const {
    control,
    register,
    getValues,
                  ...
                  <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                    <div className={styles.date2}>
                      <p style={{ marginLeft: "30px", marginRight: "30px" }}>
                        1) I am coming on my own responsibility at the{" "}
                        <b>
                          {" "}
                          {
                        ...
                        ground of Pimpri Chinchwad Municipal Corporation. 2) I
                        have made online booking to come to the{" "}
                        <b>
                          {" "}
                          {
                            venueState?.find((i) => i?.id == data?.venue)?.venue
                        ...
                        ground of Pimpri Chinchwad Municipal Corporation and the
                  ...
                  <div className={styles.date4} style={{ marginBottom: "2vh" }}>
                    <div className={styles.date2}>
                      <p style={{ marginLeft: "30px", marginRight: "30px" }}>
                        ...
                        मैदानावर मी स्वतःच्या जबाबदारी वर येत आहे. 2) पिंपरी
                        ...
                        येथील मैदानावर येण्यासाठी मी ऑनलाईन बुकींग केलेले असून
                        ऑनलाईन बुकींग साठी माझी दिलेली माहिती व प्रमाणपत्र खरी
                        आहेत. सदर माहिती व प्रमाणपत्र खोटी आढळून आल्यास त्याची
                        संपुर्ण जबाबदारी माझी राहील याची मला जाणीव आहे.
                      </p>{" "}
                    </div>
                  </div>
                  <div
...
export default SelfDeclarationGroundBooking;
