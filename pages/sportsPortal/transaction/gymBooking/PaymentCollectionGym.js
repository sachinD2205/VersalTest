  ...
  const handlePay = () => {
    if (watch("payment.paymentType") == 2) {
      ...
      let testBody = {
        ...
        amount: sum,
        // divertPageLink: "sportsPortal/transaction/gymBooking/pgSuccess",
        divertPageLink:
          "sportsPortal/transaction/gymBooking/scrutiny/pgSuccess",
      ...
      // setValue("payment.amount", totalAmountFinal);
      setValue("payment.amount", sum);
