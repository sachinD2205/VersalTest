...
const Index = (props) => {
  ...
  // useEffect(() => {
  //   console.log(
  //     "applicableCharagestotalAmountFinal",
  //     applicableCharages,
  //     totalAmountFinal
  //   );
  ...
  useEffect(() => {
    if (router.query?.applicationId) {
      axios
        .get(
          `${urls.SPURL}/gymBooking/getById?id=${router.query?.applicationId}`,
          {
            headers: {
    ...
    <>
      <div>
        <ComponentToPrint
          ...
          applicableCharages={applicableCharages}
          ref={componentRef}
        />
      </div>
      <br />
...
class ComponentToPrint extends React.Component {
  render() {
    console.log("totalAmountFinal4324324", this?.props);
                ...
                <h5 style={{ marginLeft: "40px", marginRight: "40px" }}>
                  <b>
                    ...
                    <table id="table-to-xls" className={styles.report_table}>
                      ...
                      <tbody>
                        {this?.props?.applicableCharages?.map(
                          (charge, index) => (
                            <tr key={index + 1}>
                        ...
                        <tr>
                          ...
                          <td colSpan={4}>
                            <b>{this?.props?.dataa?.applicableCharages[0]?.totalAmount}</b>
                    ...
                    व व्यायाम शाळा नोंदणीकृत आकारण्यात येणारे शुल्क
                  </b>
                  <b> एकूण फी</b> &nbsp;
                  {/* <b>{this?.props?.totalAmountFinal}</b> */}
                  <b>{this?.props?.dataa?.applicableCharages[0]?.totalAmount}</b>
