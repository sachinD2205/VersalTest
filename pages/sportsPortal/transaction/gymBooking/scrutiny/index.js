...
import VerificationGymBooking from "../../components/VerificationGymBooking";
...
const Index = () => {
  ...
  const remarkFun = (data) => {
    ...
    if (data == "Approve") {
      ...
      axios
        .post(
          `${urls.SPURL}/gymBooking/saveApplicationApprove`,
          finalBodyForApi,
          {
            headers: {
    ...
    axios
      ...
      .then((resp) => {
        ...
        if (resp.status == 200) {
          ...
          const data = resp?.data.gymBooking?.map((data, index) => {
            return {
              ...data,
              srNo: index + 1,
              applicantNameMr:
                ...
                >
                  ...
                  >
                    ...
                    <DialogContent sx={{ overflow: "unset" }}>
                      <VerificationGymBooking props={applicationData} />
                    </DialogContent>
                    <Grid>
                      <GymHistoryComponent id={getValues("id")} />
                    </Grid>
