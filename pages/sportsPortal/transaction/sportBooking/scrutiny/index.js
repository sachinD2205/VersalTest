...
import SportsHistoryComponent from "../../components/SportsHistoryComponent";
import VerificationSportsBooking from "../../components/VerificationSportsBooking";
import BreadcrumbComponent from "../../../../../components/common/BreadcrumbComponent";
import { Schema } from "../../../../../containers/schema/sportsPortalSchema/gymScrutinySchema";
...
const Index = () => {
  ...
  const remarkFun = (data) => {
    ...
    if (data == "Approve") {
      ...
      approveRemarkMr = watch("verificationRemarkMr");
      ...
      axios
        .post(
          `${urls.SPURL}/sportsBooking/saveApplicationApprove`,
          finalBodyForApi,
          {
            headers: {
        ...
        .then((res) => {
          if (res.status == 200) {
            router.push("/sportsPortal/transaction/sportsBooking/scrutiny");
      ...
      if (
        ...
        rejectRemarkMr = watch("verificationRemarkMr");
        const finalBodyForApi = {
          approveRemark,
          rejectRemark,
          rejectRemarkMr,
  ...
  const getGymData = () => {
    ...
    axios
      .get(`${urls.SPURL}/sportsBooking/getAll`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
      .then((resp) => {
        console.log("Sports data", resp);
        // console.log("response Data", JSON.stringify(resp.data.gymBooking));

        let _data = resp.data.sportsBooking;
        if (resp.status == 200) {
          setLoadderState(false);

          const data = resp?.data.sportsBooking?.map((data, index) => {
            return {
              ...data,
              srNo: index + 1,
              applicantNameMr:
              ...
              authority?.find((r) => r == "CLERK" || r == "ADMIN") && (
                <IconButton>
                  <Button
                    ...
                    onClick={() => {
                      reset(record.row);
                      console.log("67565646", record.row);
              ...
              authority?.find(
                ...
                <IconButton>
                  ...
                  >
                    ...
                    <FormattedLabel id="vSportsOfficer" />
                  </Button>
                </IconButton>
              )}
              ...
              <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                >
                  ...
                  <DialogContent sx={{ overflow: "unset" }}>
                    <VerificationSportsBooking props={applicationData} />
                  </DialogContent>
                  <Grid>
                    <SportsHistoryComponent id={getValues("id")} />
                  </Grid>
                  <DialogTitle>
                    <Typography
                    ...
                    >
                      ...
                      <FormattedLabel id="enterRemarkForApplicationEn" />
                    </Typography>
                    ...
                    {/* <Typography
                        variant="h6"
                      >
                        <FormattedLabel id="enterRemarkForApplicationMr" />
                      </Typography>
                      <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                        <TextareaAutosize
                          style={{
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                      ...
                      >
                        <Button
                          ...
                          disabled={
                            watch("approveBtnState") === "ENABLE" ? false : true
                          }
                          onClick={() => {
                            remarkFun("Approve");
                          }}
