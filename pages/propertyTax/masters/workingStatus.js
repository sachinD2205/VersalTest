...
const Index = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) =>
        setAssetName(
          res.data.assetType.map((j) => ({
            id: j.id,
            assetType: j.assetType,
            assetNameEn: j.assetName,
            assetNameMr: j.assetNameMr,
          }))
        )
      )
  ...
  const getTableData = (pageSize = 10, pageNo = 0) => {
    axios
      ...
      .then((res) => {
        setTable(
          res.data.workingStatus.map((j, i) => ({
            srNo: i + 1,
            id: j.id,
            fromDate: j.fromDate,
            toDate: j.toDate,
            remark: j.remark,
            assetWorkingStatusPrefix: j.assetWorkingStatusPrefix,
            assetWorkingStatusEn: j.assetWorkingStatus,
            // assetWorkingStatusMr: j.assetWorkingStatusMr,
            assetType: j.assetType,
            assetNameEn: assetName.find((obj) => obj.id == j.assetType)
              ?.assetNameEn,
            assetNameMr: assetName.find((obj) => obj.id == j.assetType)
              ?.assetNameMr,
  ...
  const columns = [
    ...
    },
    {
      ...
      // field: language == "en" ? "assetWorkingStatusEn" : "assetWorkingStatusMr",
      field: "assetWorkingStatusEn",
      align: "center",
      headerAlign: "center",
...

    {
      ...
      field: language == "en" ? "assetNameEn" : "assetNameMr",
      align: "center",
      headerAlign: "center",
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                reset({
                  ...
                  assetWorkingStatusPrefix: params.row.assetWorkingStatusPrefix,
                  assetWorkingStatus: params.row.assetWorkingStatusEn,
                  // assetWorkingStatusMr: params.row.assetWorkingStatusMr,
  ...
  const deleteById = (rowData, flag) => {
    sweetAlert({
      ...
      if (ok) {
        axios
          .post(
            `${URLs.PTAXURL}/master/workingStatus/save`,
            {
              ...rowData,
    ...
    <>
      ...
      <Paper className={styles.main}>
        <div className={styles.title}>
          <FormattedLabel id="assetWorkingStatus" />
        </div>
          ...
          <Slide direction="down" in={collapse} mountOnEnter unmountOnExit>
            <div>
              <div className={styles.row}>
                <TextField
                  sx={{ width: "250px" }}
                  label={<FormattedLabel id="assetWorkingStatusPrefix" />}
                  variant="standard"
                  {...register("assetWorkingStatusPrefix")}
                  InputLabelProps={{
                    shrink: watch("assetWorkingStatusPrefix") ? true : false,
                  }}
                  error={!!errors.assetWorkingStatusPrefix}
                  helperText={
                    errors?.assetWorkingStatusPrefix
                      ? errors.assetWorkingStatusPrefix.message
                      : null
                  }
                />
              ...
              <div className={styles.row}>
                <FormControl variant="standard" error={!!errors.assetType}>
                ...
                <TextField
                  ...
                  InputLabelProps={{
                    shrink: watch("assetWorkingStatus") ? true : false,
                  }}
