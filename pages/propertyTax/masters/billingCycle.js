...
const Index = () => {
  ...
  let schema = yup.object().shape({
    ...
    billingCycle: yup
      .string()
      .required("Please enter a billing cycle")
      .matches(
        /^[A-Za-z0-9\s]+$/,
        "Must be only english characters / फक्त इंग्लिश शब्द "
      ),
  ...
  const getTableData = (pageSize = 10, pageNo = 0) => {
    axios
      .get(`${URLs.PTAXURL}/master/billingCycleNameMaster/getAll`, {
        headers: {
      ...
      .then((res) => {
        setTable(
          res.data.billingCycleName.map((j, i) => ({
            srNo: i + 1,
            id: j.id,
            fromDate: j.fromDate,
            toDate: j.toDate,
            remark: j.remark,
            billingCyclePrefix: j.billingCyclePrefix,
            billingCycleEn: j.billingCycle,
            // billingCycleMr: j.billingCycleMr,
  ...
  const columns = [
    ...
    },
    {
      ...
      // field: language == "en" ? "billingCycleEn" : "billingCycleMr",
      field: "billingCycleEn",
      align: "center",
      headerAlign: "center",
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                reset({
                  ...
                  billingCyclePrefix: params.row.billingCyclePrefix,
                  billingCycle: params.row.billingCycleEn,
                  // billingCycleMr: params.row.billingCycleMr,
                });
                setCollapse(true);
              }}
            >
  ...
  const deleteById = (rowData, flag) => {
    sweetAlert({
      ...
      if (ok) {
        axios
          .post(
            `${URLs.PTAXURL}/master/billingCycleNameMaster/save`,
            {
              ...rowData,
  ...
  return (
    <>
      <Head>
        <title>Billing Cycle Master</title>
      </Head>
            ...
            <div>
              <div className={styles.row}>
                <TextField
                  ...
                  InputLabelProps={{
                    shrink: watch("billingCyclePrefix") ? true : false,
                  }}
              ...
              <div className={styles.row}>
                <TextField
                  ...
                  InputLabelProps={{
                    shrink: watch("billingCycle") ? true : false,
                  }}
