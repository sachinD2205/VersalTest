...
const Index = () => {
  ...
  const getTableData = (pageSize = 10, pageNo = 0) => {
    axios
      .get(`${URLs.PTAXURL}/master/factorMaster/getAll`, {
        headers: {
      ...
      .then((res) => {
        setTable(
          res.data.factor.map((j, i) => ({
            srNo: i + 1,
            id: j.id,
            fromDate: j.fromDate,
            toDate: j.toDate,
            remark: j.remark,
            factorPrefix: j.factorPrefix,
            factorNameEn: j.factorName,
            // factorNameMr: j.factorNameMr,
  ...
  const columns = [
    ...
    },
    {
      ...
      // field: language == "en" ? "factorNameEn" : "factorNameMr",
      field: "factorNameEn",
      align: "center",
      headerAlign: "center",
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                reset({
                  ...
                  factorPrefix: params.row.factorPrefix,
                  factorName: params.row.factorNameEn,
                  // factorNameMr: params.row.factorNameMr,
                });
                setCollapse(true);
              }}
            >
  ...
  const deleteById = (rowData, flag) => {
    sweetAlert({
      ...
      if (ok) {
        axios
          .post(
            `${URLs.PTAXURL}/master/factorMaster/save`,
            {
              ...rowData,
            ...
            <div>
              <div className={styles.row}>
                <TextField
                  ...
                  InputLabelProps={{
                    shrink: watch("factorPrefix") ? true : false,
                  }}
              ...
              <div className={styles.row}>
                <TextField
                  ...
                  {...register("factorName")}
                  InputLabelProps={{
                    shrink: watch("factorName") ? true : false,
                  }}
