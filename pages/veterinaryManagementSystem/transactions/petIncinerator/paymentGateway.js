...
const Index = () => {
  ...
  const [paymentType, setPaymentType] = useState([
    ...
    { type: 'online', nameEn: 'UPI', nameMr: 'युपीआय', value: 'UPI' },
    {
      type: 'offline',
      nameEn: 'Demand Draft',
  ...
  const handlePay = (data) => {
    ...
    if (watch('paymentMode') == 'online') {
      ...
      let testBody = {
        ...
        amount: watch('amount'),
        divertPageLink:
          'veterinaryManagementSystem/transactions/petIncinerator/pgSuccess',
  ...
  const finalSubmit = (data) => {
    ...
    const { payerName, amount, paymentMode } = data
    let bodyForAPI,
      paymentType = null
    ...
    axios
      .post(
        `${URLs.VMS}/trnSmallPetIncineration/processPaymentCollection`,
        bodyForAPI,
        {
          headers: {
            Authorization: `Bearer ${userToken}`,
