...
const Index = () => {
  ...
  let petSchema = yup.object().shape({
    petAnimalKey: yup
      .number()
      .required(
        language == 'en' ? 'Please select a pet' : 'कृपया पाळीव प्राणी निवडा'
      )
      .typeError(
        language == 'en' ? 'Please select a pet' : 'कृपया पाळीव प्राणी निवडा'
      ),
            ...
            <>
              <div className={styles.row}>
                {language === 'en' ? (
                  ...
                  <label className={styles.subHeader}>
                    नियम व अटी खालील प्रमाणे राहतील
                  </label>
                )}
              </div>
              {pet == 'Dog' && language === 'en' && (
                <div className={styles.terms}>
                  ...
                  <br /> 1. The legal term of this license is one year from the
                  date of issue of the license and it shall be mandatory to
                  renew it annually.
                  ...
                  conditions after payment of fees decided by Hon'ble Municipal
                  Commissioner from time to time.
                  <br /> 4. The license holder shall carry the license obtained
                  with him and shall produce the same on demand by the Hon'ble
                  Municipal Commissioner or the authorized officer appointed by
                  him.
                  ...
                  <br /> 11. Do not leave your dog (unchained) in public
                  places,crowded and traffic places, in public gardens. Also,
                  you should take care not to disturb the citizens by barking or
                  running over them and biting them.
                  <br /> 12. The rules and provisions of the Bombay Provincial
                  M.N.P. Act, 1949,Chapter Appendix 14 Rule 22 including Section
                  386 (1) of the Dog Tax Bye-law shall remain binding on license
                  holders.
                  ...
                  <br /> 14. After obtaining the said license, if a complaint is
                  received by the PCMC on the grounds of human health and public
                  hygiene, the PCMC reserves the right to take appropriate
                  action and/or cancel the license given considering the
                  seriousness of the complaint. have been retained by
                </div>
              )}
              {pet == 'Dog' && language !== 'en' && (
                <div className={styles.terms}>
                  ...
                  <div>
                    <br /> 1. या परवान्याची कायदेशीर मुदत परवाना प्राप्त झाले
                    पासुन एक वर्षापुरती असून तो दरसाल नुतनीकरण करणे बंधनकारक
                    राहील.
                    <br /> 2. या परवान्याची कायदेशीर मुदत संपल्यानंतर १५
                    दिवसांच्या आत नुतनीकरण करणे बंधनकारक राहील, अन्यथा १० रु.
                    दंड आकारण्यात येइल.
                    ...
                    रक्कम रुपये पाचशे फक्त) इतका दंड आकारण्यात येईल.
                    <br /> 11. सार्वजनिक ठिकाणी, गर्दीचे आणि रहदारीचे ठिकाणी,
                    सार्वजनिक बागेमध्ये आपला श्वान साखळी व्यतिरिक्त (मोकळा)सोडू
                    नये. तसेच नागरिकांना भुंकण्याचा किंवा अंगावर धावून
              ...
              {pet == 'Cat' && language === 'en' && (
                <div className={styles.terms}>
                  ...
                  <br /> 6. The license holder should not let the cat loose in
                  the public place or on the road. Also, care should be taken to
                  ...
                  14 Rule 22 shall remain binding on the license holders.
                  <br /> 10. No person shall keep a cat unless he obtains a
                  license under Bombay Provincial Municipal Act 1949 Chapter
                  Appendix 14 Rule 22 (1) (a). But if the license has been
                  obtained and not renewed, the concerned person will be deemed
                  to have kept a cat without a license and will be eligible for
              ...
              {pet == 'Cat' && language === 'mr' && (
                <div className={styles.terms}>
                  ...
                  राहील.
                  <br /> 2. या परवान्याची कायदेशीर मुदत संपल्यानंतर १५
                  दिवसांच्या आत नुतनीकरण करणे बंधनकारक राहील, अन्यथा १० रु. दंड
                  आकारण्यात येइल.
                  <br /> 3. मा.महापालिका आयुक्त यांनी वेळोवेळी ठरविलेले शुल्क
                  अदा केल्यानंतर अटी व शर्तीस अधीन राहुन परवाना देण्यात येईल.
                  <br /> 4. परवाना धारकाने प्राप्त परवाना सोबत बाळगणे आवश्यक
                  ...
                  <br /> 10. सदरचा परवाना घेतल्यानंतर मानवी आरोग्यास तसेच
                  सार्वजनिक स्वच्छतेच्या कारणावरून म.न.पा.कडे तक्रार प्राप्त
                  झाल्यास तक्रारीचे गांभीर्य लक्षात घेऊन योग्य ती कारवाई करणे
                  आणि / किंवा दिलेला परवाना रद्द करण्याचे अधिकार म.न.पा.ने राखून
                  उक्त नमुद केलेप्रमाणे शुल्क आकारुन अटी व शर्तीस अधीन राहुन
                  मांजरास ऑनलाईन पध्दतीने परवाना देणेस मान्यता असावी.
                </div>
              )}
