...
const Index = (props) => {
        ...
        if (cfcDetails?.balanceAvailableRs < showData?.depositAmount) {
          ...
          console.log(
            ...
            JSON.parse(router?.query?.data),
            {
              ...
              mer_amount: showData?.extraEquipmentUsedChargesAmout,
              merchant_param5: showData?.applicationNumber,
            }
          );
          ...
          axios
            ...
            .then((res) => {
              ...
              swal({
                ...
                console.log("User choice:", userChoice, router.query);
  ...
  const addToCfcBalanceHistory = () => {
    ...
    const finalBody = {
      ...
      paymentAmount: showData?.extraEquipmentUsedChargesAmout,
            ...
            <table className={styles.__table}>
              ...
              <tr className={styles.__tr}>
                ...
                <td className={styles.__td}>
                  Extra Equipment Used Charges / अतिरिक्त उपकरणे वापरलेले शुल्क
                </td>
                <td className={styles.__tdAmt}>
                  <b>{showData?.extraEquipmentUsedChargesAmout}</b>
                </td>
              </tr>
              {/* <tr className={styles.__tr}>
