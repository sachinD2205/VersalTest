            ...
            swal({
              ...
              if (willDelete) {
                ...
                _loggedInUser == "cfcUser"
                  ...
                  : router.push({
                      pathname: "/PublicAuditorium/dashboard",
                      // query: { data: router?.query?.data },
                    });
                // _loggedInUser == "cfcUser"
                //   ? router.push({
...
class ComponentToPrint extends React.Component {
  render() {
    ...
    const rupeesWords =
      this?.props?.data?.rentAmountWithoutGst &&
      converter.toWords(
        Math.floor(
          (
            (this?.props?.data?.rentAmountWithoutGst * 18) / 100 +
            this?.props?.data?.rentAmountWithoutGst
          ).toFixed(2)
        )
      );
                ...
                <tbody>
                  <tr>
                    ...
                    <td style={{ padding: "5px" }}>
                      Rehearsal Rent Amount / रंगीत तालीम भाडे रक्कम
                    </td>
                    <td
                      style={{
                        textAlign: "right",
                    ...
                    >
                      <b>
                        {this?.props?.data?.rentAmountWithoutGst?.toFixed(2)}
                      </b>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style={{ textAlign: "right", padding: "5px" }}>
                      <b>
                        {(this?.props?.data?.rentAmountWithoutGst * 9) / 100}
                      </b>
                    </td>
                  </tr>
                  <tr>
